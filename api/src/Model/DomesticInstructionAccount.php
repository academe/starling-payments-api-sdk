...
/**
 * DomesticInstructionAccount Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DomesticInstructionAccount implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomesticInstructionAccount';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accountNumber'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'accountNumber');
        }
        if ((mb_strlen($this->container['accountNumber']) > 8)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be smaller than or equal to %d.',
                'accountNumber',
                8
        ...
        if (! preg_match("/\\d{8}/", $this->container['accountNumber'])) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be conform to the pattern "%s".',
                'accountNumber',
                "/\\d{8}/"
        ...
        if (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,40}/", $this->container['accountName'])) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be conform to the pattern "%s".',
                'accountName',
                "/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,40}/"
    ...
    public function setSortCode($sortCode)
    {
        if ((mb_strlen($sortCode) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sortCode when calling DomesticInstructionAccount., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($sortCode) < 6)) {
            throw new \InvalidArgumentException('invalid length for $sortCode when calling DomesticInstructionAccount., must be bigger than or equal to 6.');
        }
        if ((! preg_match("/\\d{6}/", $sortCode))) {
            throw new \InvalidArgumentException("invalid value for $sortCode when calling DomesticInstructionAccount., must conform to the pattern /\\d{6}/.");
        }
    ...
    public function setAccountNumber($accountNumber)
    {
        if ((mb_strlen($accountNumber) > 8)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling DomesticInstructionAccount., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($accountNumber) < 8)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling DomesticInstructionAccount., must be bigger than or equal to 8.');
        }
        if ((! preg_match("/\\d{8}/", $accountNumber))) {
            throw new \InvalidArgumentException("invalid value for $accountNumber when calling DomesticInstructionAccount., must conform to the pattern /\\d{8}/.");
        }
    ...
    public function setAccountName($accountName)
    {
        if ((mb_strlen($accountName) > 40)) {
            throw new \InvalidArgumentException('invalid length for $accountName when calling DomesticInstructionAccount., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($accountName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $accountName when calling DomesticInstructionAccount., must be bigger than or equal to 0.');
        }
        if ((! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,40}/", $accountName))) {
            throw new \InvalidArgumentException("invalid value for $accountName when calling DomesticInstructionAccount., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,40}/.");
        }
