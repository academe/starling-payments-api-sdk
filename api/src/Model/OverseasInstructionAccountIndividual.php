...
/**
 * OverseasInstructionAccountIndividual Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OverseasInstructionAccountIndividual implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OverseasInstructionAccountIndividual';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['firstName']) > 40)) {
        ...
        if ((mb_strlen($this->container['firstName']) < 0)) {
            $invalidProperties[] = sprintf(
        ...
        if (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/", $this->container['firstName'])) {
            $invalidProperties[] = sprintf(
        ...
        if (! is_null($this->container['middleName']) && (mb_strlen($this->container['middleName']) > 40)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be smaller than or equal to %d.',
                'middleName',
                40
        ...
        if (! is_null($this->container['middleName']) && ! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/", $this->container['middleName'])) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be conform to the pattern "%s".',
                'middleName',
                "/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/"
        ...
        if ((mb_strlen($this->container['lastName']) > 40)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be smaller than or equal to %d.',
                'lastName',
                40
        ...
        if (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/", $this->container['lastName'])) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be conform to the pattern "%s".',
                'lastName',
                "/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/"
     ...
     * Sets firstName
     *
     * @param string $firstName First name of originating account holder
     *
     * @return $this
     */
    public function setFirstName($firstName)
    {
        if ((mb_strlen($firstName) > 40)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling OverseasInstructionAccountIndividual., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($firstName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling OverseasInstructionAccountIndividual., must be bigger than or equal to 0.');
        }
        if ((! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/", $firstName))) {
            throw new \InvalidArgumentException("invalid value for $firstName when calling OverseasInstructionAccountIndividual., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/.");
        }
     ...
     * Sets middleName
     *
     * @param string|null $middleName Middle name of originating account holder
     *
     * @return $this
     */
    public function setMiddleName($middleName)
    {
        if (! is_null($middleName) && (mb_strlen($middleName) > 40)) {
            throw new \InvalidArgumentException('invalid length for $middleName when calling OverseasInstructionAccountIndividual., must be smaller than or equal to 40.');
        }
        if (! is_null($middleName) && (mb_strlen($middleName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $middleName when calling OverseasInstructionAccountIndividual., must be bigger than or equal to 0.');
        }
        if (! is_null($middleName) && (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/", $middleName))) {
            throw new \InvalidArgumentException("invalid value for $middleName when calling OverseasInstructionAccountIndividual., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/.");
        }
     ...
     * Sets lastName
     *
     * @param string $lastName Last name of originating account holder
     *
     * @return $this
     */
    public function setLastName($lastName)
    {
        if ((mb_strlen($lastName) > 40)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling OverseasInstructionAccountIndividual., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($lastName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling OverseasInstructionAccountIndividual., must be bigger than or equal to 0.');
        }
        if ((! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/", $lastName))) {
            throw new \InvalidArgumentException("invalid value for $lastName when calling OverseasInstructionAccountIndividual., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/.");
        }
     ...
     * Sets dateOfBirth
     *
     * @param \DateTime $dateOfBirth Date of birth of originating account holder
     *
     * @return $this
     */
