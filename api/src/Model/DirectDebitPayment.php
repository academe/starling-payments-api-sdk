...
/**
 * DirectDebitPayment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DirectDebitPayment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DirectDebitPayment';
    ...
    protected static $openAPITypes = [
        ...
        'addressUid' => 'string',
        'mandateUid' => 'string',
        'bacsPaymentUid' => 'string',
        'amount' => '\Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount',
        'reference' => 'string',
    ...
    protected static $setters = [
        ...
        'mandateUid' => 'setMandateUid',
        'bacsPaymentUid' => 'setBacsPaymentUid',
        'amount' => 'setAmount',
        'reference' => 'setReference',
        'paymentInstruction' => 'setPaymentInstruction',
        'paymentDueAt' => 'setPaymentDueAt',
    ...
    protected static $getters = [
        ...
        'mandateUid' => 'getMandateUid',
        'bacsPaymentUid' => 'getBacsPaymentUid',
        'amount' => 'getAmount',
    ...
    const PAYMENT_INSTRUCTION_SHOULD_PAY = 'SHOULD_PAY';
    const PAYMENT_INSTRUCTION_INSUFFICIENT_FUNDS = 'INSUFFICIENT_FUNDS';const REJECTION_REASON_ACCOUNT_INSUFFICIENT_FUNDS = 'ACCOUNT_INSUFFICIENT_FUNDS';
    const REJECTION_REASON_INSTRUCTED_INSUFFICIENT_FUNDS = 'INSTRUCTED_INSUFFICIENT_FUNDS';const PAYMENT_STATUS_DUE = 'DUE';
    const PAYMENT_STATUS_PROCESSED_SUCCESS = 'PROCESSED_SUCCESS';
    const PAYMENT_STATUS_PROCESSED_FAILURE = 'PROCESSED_FAILURE';
    ...
    {
        return [
            self::PAYMENT_INSTRUCTION_SHOULD_PAY,
            self::PAYMENT_INSTRUCTION_INSUFFICIENT_FUNDS,
        ];
    }
    ...
    {
        return [
            self::REJECTION_REASON_ACCOUNT_INSUFFICIENT_FUNDS,
            self::REJECTION_REASON_INSTRUCTED_INSUFFICIENT_FUNDS,
        ];
    }
    ...
    public function getPaymentStatusAllowableValues()
    {
        return [
            ...
            self::PAYMENT_STATUS_PROCESSED_SUCCESS,
            self::PAYMENT_STATUS_PROCESSED_FAILURE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['mandateUid'] = $data['mandateUid'] ?? null;
        $this->container['bacsPaymentUid'] = $data['bacsPaymentUid'] ?? null;
        $this->container['amount'] = $data['amount'] ?? null;
        $this->container['reference'] = $data['reference'] ?? null;
        $this->container['paymentInstruction'] = $data['paymentInstruction'] ?? null;
        $this->container['paymentDueAt'] = $data['paymentDueAt'] ?? null;
        $this->container['receivedAt'] = $data['receivedAt'] ?? null;
        $this->container['cancelledAt'] = $data['cancelledAt'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['paymentInstruction']) && !in_array($this->container['paymentInstruction'], $allowedValues, true)) {
     ...
     *
     * @param string|null $paymentBusinessUid Unique identifier of the company that owns this mandate
     *
     * @return $this
     */
     ...
     *
     * @param string|null $paymentAccountUid Unique identifier of the account which will make any payments associated with this mandate
     *
     * @return $this
     */
     ...
     * Sets addressUid
     *
     * @param string|null $addressUid Unique identifier of the address the mandate was set up for
     *
     * @return $this
     */
    ...
    {
        return $this->get('mandateUid');
    }

    /**
     * Sets mandateUid
     *
     * @param string|null $mandateUid Unique identifier of the mandate
     *
     * @return $this
     */
    public function setMandateUid($mandateUid)
    {
        $this->container['mandateUid'] = $mandateUid;
     ...
     * @return string|null
     */
    public function getBacsPaymentUid()
    {
        return $this->get('bacsPaymentUid');
    }

    /**
     * Sets bacsPaymentUid
     *
     * @param string|null $bacsPaymentUid Unique identifier of the payment
     *
     * @return $this
     */
    public function setBacsPaymentUid($bacsPaymentUid)
    {
        $this->container['bacsPaymentUid'] = $bacsPaymentUid;
     ...
     * Sets amount
     *
     * @param \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount|null $amount amount
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param string|null $reference The originator defined reference for the payment
     *
     * @return $this
     */
    ...
    /**
     * Sets paymentInstruction
     *
     * @param string|null $paymentInstruction Whether direct debit payment should be (or have been) paid
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getPaymentInstructionAllowableValues();
        if (! is_null($paymentInstruction) && !in_array($paymentInstruction, $allowedValues, true)) {
        ...
        $this->container['paymentInstruction'] = $paymentInstruction;
    ...
    {
        return $this->get('paymentDueAt');
    }

    /**
     * Sets paymentDueAt
     *
     * @param \DateTime|null $paymentDueAt Date and time at which payment is (or was) due to be made
     *
     * @return $this
     */
    public function setPaymentDueAt($paymentDueAt)
    {
        $this->container['paymentDueAt'] = $paymentDueAt;
     ...
     * Sets receivedAt
     *
     * @param \DateTime|null $receivedAt Date and time at which payment was debited from the account, if accepted
     *
     * @return $this
     */
     ...
     * Sets cancelledAt
     *
     * @param \DateTime|null $cancelledAt Date and time at which payment was cancelled, if rejected
     *
     * @return $this
     */
     ...
     *
     * @param string|null $rejectionReason Reason for rejection of payment, if rejected; ACCOUNT_INSUFFICIENT_FUNDS means the account owning the address had insufficient funds to make the payment; INSTRUCTED_INSUFFICIENT_FUNDS means that payment was instructed to not be paid due to insufficient customer funds
     *
     * @return $this
     */
     ...
     * Sets paymentStatus
     *
     * @param string|null $paymentStatus Current status of the direct debit payment; DUE means the payment has not been processed yet; PROCESSED_SUCCESS means the payment has been made; PROCESSED_FAILURE means the payment was rejected due to lack of funds
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getPaymentStatusAllowableValues();
        if (! is_null($paymentStatus) && !in_array($paymentStatus, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    'Invalid value for "%s", must be one of "%s"',
                    'paymentStatus',
