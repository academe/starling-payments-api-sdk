...
/**
 * CreatePaymentAccountAddressResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class CreatePaymentAccountAddressResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentAccountAddressResponse';
     ...
     * Sets accountNumber
     *
     * @param string|null $accountNumber UK account number allocated to the address
     *
     * @return $this
     */
     ...
     * Sets sortCode
     *
     * @param string|null $sortCode UK sort code allocated to the address
     *
     * @return $this
     */
