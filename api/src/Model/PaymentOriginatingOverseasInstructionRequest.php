...
/**
 * PaymentOriginatingOverseasInstructionRequest Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaymentOriginatingOverseasInstructionRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentOriginatingOverseasInstructionRequest';
    ...
    protected static $openAPITypes = [
        'destinationAccount' => '\Academe\Starling\PaymentsSdk\Model\DomesticInstructionAccount',
        'overseasInstructingAccount' => '\Academe\Starling\PaymentsSdk\Model\OverseasInstructionAccount',
        'reference' => 'string',
        'additionalRemittanceInformation' => 'string',
        'amountInDestinationCurrency' => '\Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount',
        'amountInOriginalCurrency' => '\Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount',
        'exchangeRate' => 'float'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'overseasInstructingAccount' => null,
        'reference' => null,
        'additionalRemittanceInformation' => null,
        'amountInDestinationCurrency' => null,
    ...
    protected static $attributeMap = [
        ...
        'overseasInstructingAccount' => 'overseasInstructingAccount',
        'reference' => 'reference',
    ...
    protected static $setters = [
        ...
        'overseasInstructingAccount' => 'setOverseasInstructingAccount',
        'reference' => 'setReference',
        'additionalRemittanceInformation' => 'setAdditionalRemittanceInformation',
        'amountInDestinationCurrency' => 'setAmountInDestinationCurrency',
        'amountInOriginalCurrency' => 'setAmountInOriginalCurrency',
    ...
    protected static $getters = [
        ...
        'overseasInstructingAccount' => 'getOverseasInstructingAccount',
        'reference' => 'getReference',
        'additionalRemittanceInformation' => 'getAdditionalRemittanceInformation',
        'amountInDestinationCurrency' => 'getAmountInDestinationCurrency',
        'amountInOriginalCurrency' => 'getAmountInOriginalCurrency',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['overseasInstructingAccount'] = $data['overseasInstructingAccount'] ?? null;
        $this->container['reference'] = $data['reference'] ?? null;
        $this->container['additionalRemittanceInformation'] = $data['additionalRemittanceInformation'] ?? null;
        $this->container['amountInDestinationCurrency'] = $data['amountInDestinationCurrency'] ?? null;
        $this->container['amountInOriginalCurrency'] = $data['amountInOriginalCurrency'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['destinationAccount'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'destinationAccount');
        }
        if ($this->container['overseasInstructingAccount'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'overseasInstructingAccount');
        }
        if ($this->container['reference'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'reference');
        }
        ...
        if (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,18}/", $this->container['reference'])) {
            $invalidProperties[] = sprintf(
        ...
        if ($this->container['amountInDestinationCurrency'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'amountInDestinationCurrency');
        }
        if ($this->container['amountInOriginalCurrency'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'amountInOriginalCurrency');
        }
        if ($this->container['exchangeRate'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'exchangeRate');
        }
     ...
     *
     * @return \Academe\Starling\PaymentsSdk\Model\DomesticInstructionAccount
     */
     ...
     *
     * @param \Academe\Starling\PaymentsSdk\Model\DomesticInstructionAccount $destinationAccount destinationAccount
     *
     * @return $this
     */
    ...
    /**
     * Gets overseasInstructingAccount
     *
     * @return \Academe\Starling\PaymentsSdk\Model\OverseasInstructionAccount
     */
    public function getOverseasInstructingAccount()
    {
        return $this->get('overseasInstructingAccount');
    }

    /**
     * Sets overseasInstructingAccount
     *
     * @param \Academe\Starling\PaymentsSdk\Model\OverseasInstructionAccount $overseasInstructingAccount overseasInstructingAccount
     *
     * @return $this
     */
    public function setOverseasInstructingAccount($overseasInstructingAccount)
    {
        $this->container['overseasInstructingAccount'] = $overseasInstructingAccount;
     ...
     * Sets reference
     *
     * @param string $reference The reference to be sent on the payment
     *
     * @return $this
     */
    public function setReference($reference)
    {
        if ((mb_strlen($reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling PaymentOriginatingOverseasInstructionRequest., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($reference) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling PaymentOriginatingOverseasInstructionRequest., must be bigger than or equal to 1.');
        }
        if ((! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,18}/", $reference))) {
            throw new \InvalidArgumentException("invalid value for $reference when calling PaymentOriginatingOverseasInstructionRequest., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,18}/.");
        }
    ...
    public function setAdditionalRemittanceInformation($additionalRemittanceInformation)
    {
        if (! is_null($additionalRemittanceInformation) && (mb_strlen($additionalRemittanceInformation) > 140)) {
            throw new \InvalidArgumentException('invalid length for $additionalRemittanceInformation when calling PaymentOriginatingOverseasInstructionRequest., must be smaller than or equal to 140.');
        }
        if (! is_null($additionalRemittanceInformation) && (mb_strlen($additionalRemittanceInformation) < 0)) {
            throw new \InvalidArgumentException('invalid length for $additionalRemittanceInformation when calling PaymentOriginatingOverseasInstructionRequest., must be bigger than or equal to 0.');
        }
        if (! is_null($additionalRemittanceInformation) && (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,140}/", $additionalRemittanceInformation))) {
            throw new \InvalidArgumentException("invalid value for $additionalRemittanceInformation when calling PaymentOriginatingOverseasInstructionRequest., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,140}/.");
        }
    ...
    /**
     * Gets amountInDestinationCurrency
     *
     * @return \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount
     */
    public function getAmountInDestinationCurrency()
    {
        return $this->get('amountInDestinationCurrency');
    }

    /**
     * Sets amountInDestinationCurrency
     *
     * @param \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount $amountInDestinationCurrency amountInDestinationCurrency
     *
     * @return $this
     */
    public function setAmountInDestinationCurrency($amountInDestinationCurrency)
    {
        $this->container['amountInDestinationCurrency'] = $amountInDestinationCurrency;

        return $this;
    }

    /**
     * Gets amountInOriginalCurrency
     *
     * @return \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount
     */
    public function getAmountInOriginalCurrency()
    {
        return $this->get('amountInOriginalCurrency');
    }

    /**
     * Sets amountInOriginalCurrency
     *
     * @param \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount $amountInOriginalCurrency amountInOriginalCurrency
     *
     * @return $this
     */
    public function setAmountInOriginalCurrency($amountInOriginalCurrency)
    {
        $this->container['amountInOriginalCurrency'] = $amountInOriginalCurrency;
     ...
     * Sets exchangeRate
     *
     * @param float $exchangeRate The exchange rate used to convert the original amount to the destination amount
     *
     * @return $this
     */
