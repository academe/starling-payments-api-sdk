...
/**
 * PaymentAccountAddress Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PaymentAccountAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentAccountAddress';
    ...
    protected static $openAPITypes = [
        ...
        'accountName' => 'string',
        'status' => 'string',
        'fasterPaymentsStatus' => '\Academe\Starling\PaymentsSdk\Model\AddressFasterPaymentsStatus',
        'bacsStatus' => '\Academe\Starling\PaymentsSdk\Model\AddressBacsStatus'
    ];
    ...
    protected static $attributeMap = [
        ...
        'status' => 'status',
        'fasterPaymentsStatus' => 'fasterPaymentsStatus',
        'bacsStatus' => 'bacsStatus'
    ];
    ...
    protected static $setters = [
        ...
        'status' => 'setStatus',
        'fasterPaymentsStatus' => 'setFasterPaymentsStatus',
        'bacsStatus' => 'setBacsStatus'
    ];
    ...
    protected static $getters = [
        ...
        'status' => 'getStatus',
        'fasterPaymentsStatus' => 'getFasterPaymentsStatus',
        'bacsStatus' => 'getBacsStatus'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['accountUid'] = $data['accountUid'] ?? null;
        ...
        $this->container['fasterPaymentsStatus'] = $data['fasterPaymentsStatus'] ?? null;
        $this->container['bacsStatus'] = $data['bacsStatus'] ?? null;
    }
    ...
    {
        return $this->get('accountUid');
    }

    /**
     * Sets accountUid
     *
     * @param string|null $accountUid Unique identifier of the account which holds funds
     *
     * @return $this
     */
     ...
     * Sets addressUid
     *
     * @param string|null $addressUid Unique identifier of the payment account address
     *
     * @return $this
     */
     ...
     * Sets sortCode
     *
     * @param string|null $sortCode Sort code for the account, used to receive payments into the account
     *
     * @return $this
     */
     ...
     * Sets accountNumber
     *
     * @param string|null $accountNumber Account number, used to receive payments into the account
     *
     * @return $this
     */
     ...
     * Sets createdAt
     *
     * @param \DateTime|null $createdAt Date and time the account was first created
     *
     * @return $this
     */
     ...
     * Sets accountName
     *
     * @param string|null $accountName Name for the account, this will be included in outbound faster payment messages to other recipients
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Overall status of the address.
     *
     * @return $this
     */
    ...
    /**
     * Gets fasterPaymentsStatus
     *
     * @return \Academe\Starling\PaymentsSdk\Model\AddressFasterPaymentsStatus|null
     */
    public function getFasterPaymentsStatus()
    {
        return $this->get('fasterPaymentsStatus');
    }

    /**
     * Sets fasterPaymentsStatus
     *
     * @param \Academe\Starling\PaymentsSdk\Model\AddressFasterPaymentsStatus|null $fasterPaymentsStatus fasterPaymentsStatus
     *
     * @return $this
     */
    public function setFasterPaymentsStatus($fasterPaymentsStatus)
    {
        $this->container['fasterPaymentsStatus'] = $fasterPaymentsStatus;
     ...
     * Gets bacsStatus
     *
     * @return \Academe\Starling\PaymentsSdk\Model\AddressBacsStatus|null
     */
    public function getBacsStatus()
    {
        return $this->get('bacsStatus');
    }

    /**
     * Sets bacsStatus
     *
     * @param \Academe\Starling\PaymentsSdk\Model\AddressBacsStatus|null $bacsStatus bacsStatus
     *
     * @return $this
     */
    public function setBacsStatus($bacsStatus)
    {
        $this->container['bacsStatus'] = $bacsStatus;
