...
/**
 * FpsInboundNotification Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class FpsInboundNotification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FpsInboundNotification';
    ...
    protected static $openAPITypes = [
        'fpid' => 'string',
        'paymentBusinessUid' => 'string',
        'paymentAccountUid' => 'string',
        'addressUid' => 'string',
        'paymentUid' => 'string',
        'sourceAccount' => '\Academe\Starling\PaymentsSdk\Model\PaymentDetailsAccount',
        'destinationAccount' => '\Academe\Starling\PaymentsSdk\Model\PaymentDetailsAccount',
        'settlementAmount' => '\Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount',
        'instructedAmount' => '\Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount',
        'reference' => 'string',
        'additionalRemittanceInformation' => 'string',
        'receivedAt' => '\DateTime',
        'returnDetails' => '\Academe\Starling\PaymentsSdk\Model\PaymentReturnDetails',
        'deadlineForReturn' => '\DateTime',
        'type' => 'string',
        'settlementCycleUid' => 'string',
        'fpsSettlementCycleId' => 'string',
        'fpsSettlementDate' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        'fpid' => null,
        'paymentBusinessUid' => 'uuid',
        'paymentAccountUid' => 'uuid',
        'addressUid' => 'uuid',
        'paymentUid' => 'uuid',
        'sourceAccount' => null,
        ...
        'returnDetails' => null,
        'deadlineForReturn' => 'date-time',
        'type' => null,
        'settlementCycleUid' => 'uuid',
        'fpsSettlementCycleId' => null,
        'fpsSettlementDate' => 'date'
    ];
    ...
    protected static $attributeMap = [
        'fpid' => 'fpid',
        'paymentBusinessUid' => 'paymentBusinessUid',
        ...
        'deadlineForReturn' => 'deadlineForReturn',
        'type' => 'type',
        'settlementCycleUid' => 'settlementCycleUid',
        'fpsSettlementCycleId' => 'fpsSettlementCycleId',
        'fpsSettlementDate' => 'fpsSettlementDate'
    ];
    ...
    protected static $setters = [
        'fpid' => 'setFpid',
        'paymentBusinessUid' => 'setPaymentBusinessUid',
        'paymentAccountUid' => 'setPaymentAccountUid',
        'addressUid' => 'setAddressUid',
        'paymentUid' => 'setPaymentUid',
        ...
        'deadlineForReturn' => 'setDeadlineForReturn',
        'type' => 'setType',
        'settlementCycleUid' => 'setSettlementCycleUid',
        'fpsSettlementCycleId' => 'setFpsSettlementCycleId',
        'fpsSettlementDate' => 'setFpsSettlementDate'
    ];
    ...
    protected static $getters = [
        'fpid' => 'getFpid',
        'paymentBusinessUid' => 'getPaymentBusinessUid',
        'paymentAccountUid' => 'getPaymentAccountUid',
        'addressUid' => 'getAddressUid',
        ...
        'deadlineForReturn' => 'getDeadlineForReturn',
        'type' => 'getType',
        'settlementCycleUid' => 'getSettlementCycleUid',
        'fpsSettlementCycleId' => 'getFpsSettlementCycleId',
        'fpsSettlementDate' => 'getFpsSettlementDate'
    ];
    ...
    const TYPE_SRN = 'SRN';
    const TYPE_RTN = 'RTN';
    const TYPE_DCA = 'DCA';const FPS_SETTLEMENT_CYCLE_ID__001 = 'CYCLE_001';
    const FPS_SETTLEMENT_CYCLE_ID__002 = 'CYCLE_002';
    const FPS_SETTLEMENT_CYCLE_ID__003 = 'CYCLE_003';
     ...
     * @return string[]
     */
    public function getFpsSettlementCycleIdAllowableValues()
    {
        return [
            self::FPS_SETTLEMENT_CYCLE_ID__001,
            self::FPS_SETTLEMENT_CYCLE_ID__002,
            self::FPS_SETTLEMENT_CYCLE_ID__003,
        ];
    }
    ...
    {
        $this->container['fpid'] = $data['fpid'] ?? null;
        $this->container['paymentBusinessUid'] = $data['paymentBusinessUid'] ?? null;
        $this->container['paymentAccountUid'] = $data['paymentAccountUid'] ?? null;
        $this->container['addressUid'] = $data['addressUid'] ?? null;
        $this->container['paymentUid'] = $data['paymentUid'] ?? null;
        $this->container['sourceAccount'] = $data['sourceAccount'] ?? null;
        $this->container['destinationAccount'] = $data['destinationAccount'] ?? null;
        ...
        $this->container['returnDetails'] = $data['returnDetails'] ?? null;
        $this->container['deadlineForReturn'] = $data['deadlineForReturn'] ?? null;
        $this->container['type'] = $data['type'] ?? null;
        $this->container['settlementCycleUid'] = $data['settlementCycleUid'] ?? null;
        $this->container['fpsSettlementCycleId'] = $data['fpsSettlementCycleId'] ?? null;
        $this->container['fpsSettlementDate'] = $data['fpsSettlementDate'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (! is_null($this->container['additionalRemittanceInformation']) && (mb_strlen($this->container['additionalRemittanceInformation']) > 140)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be smaller than or equal to %d.',
        ...
        if (! is_null($this->container['additionalRemittanceInformation']) && (mb_strlen($this->container['additionalRemittanceInformation']) < 0)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be bigger than or equal to %d.',
                'additionalRemittanceInformation',
                0
        ...
        if (! is_null($this->container['additionalRemittanceInformation']) && ! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,140}/", $this->container['additionalRemittanceInformation'])) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getFpsSettlementCycleIdAllowableValues();
        if (!is_null($this->container['fpsSettlementCycleId']) && !in_array($this->container['fpsSettlementCycleId'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be one of "%s"',
    ...
    {
        return $this->get('fpid');
    }

    /**
     * Sets fpid
     *
     * @param string|null $fpid Unique identifier of the payment within the scheme. 42 character string, in which the last five characters are almost always spaces.
     *
     * @return $this
     */
    ...
    /**
     * Gets paymentBusinessUid
     *
     * @return string|null
     */
    public function getPaymentBusinessUid()
    {
        return $this->get('paymentBusinessUid');
    }

    /**
     * Sets paymentBusinessUid
     *
     * @param string|null $paymentBusinessUid Unique identifier of the company receiving the payment
     *
     * @return $this
     */
    public function setPaymentBusinessUid($paymentBusinessUid)
    {
        $this->container['paymentBusinessUid'] = $paymentBusinessUid;

        return $this;
    }

    /**
     * Gets paymentAccountUid
     *
     * @return string|null
     */
    public function getPaymentAccountUid()
    {
        return $this->get('paymentAccountUid');
    }

    /**
     * Sets paymentAccountUid
     *
     * @param string|null $paymentAccountUid Unique identifier of the account containing the funds received
     *
     * @return $this
     */
    public function setPaymentAccountUid($paymentAccountUid)
    {
        $this->container['paymentAccountUid'] = $paymentAccountUid;
    ...
    {
        return $this->get('addressUid');
    }

    /**
     * Sets addressUid
     *
     * @param string|null $addressUid Unique identifier of the address the payment was received to
     *
     * @return $this
     */
    public function setAddressUid($addressUid)
    {
        $this->container['addressUid'] = $addressUid;
    ...
    {
        return $this->get('paymentUid');
    }

    /**
     * Sets paymentUid
     *
     * @param string|null $paymentUid Unique identifier of the payment
     *
     * @return $this
     */
    public function setPaymentUid($paymentUid)
    {
        $this->container['paymentUid'] = $paymentUid;
     ...
     * Gets sourceAccount
     *
     * @return \Academe\Starling\PaymentsSdk\Model\PaymentDetailsAccount|null
     */
    public function getSourceAccount()
    {
        return $this->get('sourceAccount');
    }

    /**
     * Sets sourceAccount
     *
     * @param \Academe\Starling\PaymentsSdk\Model\PaymentDetailsAccount|null $sourceAccount sourceAccount
     *
     * @return $this
     */
    ...
    /**
     * Gets destinationAccount
     *
     * @return \Academe\Starling\PaymentsSdk\Model\PaymentDetailsAccount|null
     */
    public function getDestinationAccount()
    {
        return $this->get('destinationAccount');
    }

    /**
     * Sets destinationAccount
     *
     * @param \Academe\Starling\PaymentsSdk\Model\PaymentDetailsAccount|null $destinationAccount destinationAccount
     *
     * @return $this
     */
    public function setDestinationAccount($destinationAccount)
    {
        $this->container['destinationAccount'] = $destinationAccount;
     ...
     *
     * @return \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount|null
     */
    public function getSettlementAmount()
    {
        return $this->get('settlementAmount');
    }

    /**
     * Sets settlementAmount
     *
     * @param \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount|null $settlementAmount settlementAmount
     *
     * @return $this
     */
    ...
    {
        return $this->get('instructedAmount');
    }

    /**
     * Sets instructedAmount
     *
     * @param \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount|null $instructedAmount instructedAmount
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param string|null $reference Reference included with the payment
     *
     * @return $this
     */
    public function setReference($reference)
    {
        if (! is_null($reference) && (mb_strlen($reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling FpsInboundNotification., must be smaller than or equal to 18.');
        }
        if (! is_null($reference) && (mb_strlen($reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling FpsInboundNotification., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->get('additionalRemittanceInformation');
    }

    /**
     * Sets additionalRemittanceInformation
     *
     * @param string|null $additionalRemittanceInformation Unstructured additional remittance information
     *
     * @return $this
     */
    public function setAdditionalRemittanceInformation($additionalRemittanceInformation)
    {
        if (! is_null($additionalRemittanceInformation) && (mb_strlen($additionalRemittanceInformation) > 140)) {
            throw new \InvalidArgumentException('invalid length for $additionalRemittanceInformation when calling FpsInboundNotification., must be smaller than or equal to 140.');
        }
        if (! is_null($additionalRemittanceInformation) && (mb_strlen($additionalRemittanceInformation) < 0)) {
            throw new \InvalidArgumentException('invalid length for $additionalRemittanceInformation when calling FpsInboundNotification., must be bigger than or equal to 0.');
        }
        if (! is_null($additionalRemittanceInformation) && (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,140}/", $additionalRemittanceInformation))) {
            throw new \InvalidArgumentException("invalid value for $additionalRemittanceInformation when calling FpsInboundNotification., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,140}/.");
        }
     ...
     * Sets receivedAt
     *
     * @param \DateTime|null $receivedAt Date and time that the payment was originally received
     *
     * @return $this
     */
     ...
     * Gets returnDetails
     *
     * @return \Academe\Starling\PaymentsSdk\Model\PaymentReturnDetails|null
     */
     ...
     * Sets returnDetails
     *
     * @param \Academe\Starling\PaymentsSdk\Model\PaymentReturnDetails|null $returnDetails returnDetails
     *
     * @return $this
     */
    public function setReturnDetails($returnDetails)
    {
        $this->container['returnDetails'] = $returnDetails;

        return $this;
    }

    /**
     * Gets deadlineForReturn
     *
     * @return \DateTime|null
     */
    public function getDeadlineForReturn()
    {
        return $this->get('deadlineForReturn');
    }

    /**
     * Sets deadlineForReturn
     *
     * @param \DateTime|null $deadlineForReturn Date and time until when the payment can be returned. Not present if the return deadline could not be calculated. Specification: FPS Procedures Chapter 3 - Faster Payments Service Operation v15.1.pdf
     *
     * @return $this
     */
    public function setDeadlineForReturn($deadlineForReturn)
    {
        $this->container['deadlineForReturn'] = $deadlineForReturn;
     ...
     * Sets type
     *
     * @param string|null $type Type of the payment that was sent or received
     *
     * @return $this
     */
    ...
    /**
     * Gets settlementCycleUid
     *
     * @return string|null
     */
    public function getSettlementCycleUid()
    {
        return $this->get('settlementCycleUid');
    }

    /**
     * Sets settlementCycleUid
     *
     * @param string|null $settlementCycleUid Unique identifier of the settlement cycle the payment is allocated to
     *
     * @return $this
     */
    public function setSettlementCycleUid($settlementCycleUid)
    {
        $this->container['settlementCycleUid'] = $settlementCycleUid;

        return $this;
    }

    /**
     * Gets fpsSettlementCycleId
     *
     * @return string|null
     */
    public function getFpsSettlementCycleId()
    {
        return $this->get('fpsSettlementCycleId');
    }

    /**
     * Sets fpsSettlementCycleId
     *
     * @param string|null $fpsSettlementCycleId Faster payment scheme identifier for the settlement cycle the payment is allocated to
     *
     * @return $this
     */
    public function setFpsSettlementCycleId($fpsSettlementCycleId)
    {
        $allowedValues = $this->getFpsSettlementCycleIdAllowableValues();
        if (! is_null($fpsSettlementCycleId) && !in_array($fpsSettlementCycleId, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    'Invalid value for "%s", must be one of "%s"',
                    'fpsSettlementCycleId',
        ...
        $this->container['fpsSettlementCycleId'] = $fpsSettlementCycleId;

        return $this;
    }

    /**
     * Gets fpsSettlementDate
     *
     * @return \DateTime|null
     */
    public function getFpsSettlementDate()
    {
        return $this->get('fpsSettlementDate');
    }

    /**
     * Sets fpsSettlementDate
     *
     * @param \DateTime|null $fpsSettlementDate Faster payment scheme settlement date
     *
     * @return $this
     */
    public function setFpsSettlementDate($fpsSettlementDate)
    {
        $this->container['fpsSettlementDate'] = $fpsSettlementDate;
