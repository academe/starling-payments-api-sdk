...
/**
 * PaymentDetailsAccount Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PaymentDetailsAccount implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsAccount';
    ...
    {
        $this->container['sortCode'] = $data['sortCode'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (! is_null($this->container['sortCode']) && (mb_strlen($this->container['sortCode']) > 6)) {
        ...
        if (! is_null($this->container['sortCode']) && ! preg_match("/\\d{6}/", $this->container['sortCode'])) {
            $invalidProperties[] = sprintf(
        ...
        if (! is_null($this->container['accountNumber']) && (mb_strlen($this->container['accountNumber']) > 34)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be smaller than or equal to %d.',
                'accountNumber',
                34
        ...
        if (! is_null($this->container['accountNumber']) && (mb_strlen($this->container['accountNumber']) < 0)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be bigger than or equal to %d.',
                'accountNumber',
                0
        ...
        if (! is_null($this->container['accountNumber']) && ! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{,34}/", $this->container['accountNumber'])) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be conform to the pattern "%s".',
                'accountNumber',
                "/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{,34}/"
        ...
        if (! is_null($this->container['bic']) && (mb_strlen($this->container['bic']) > 12)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be smaller than or equal to %d.',
                'bic',
                12
        ...
        if (! is_null($this->container['bic']) && ! preg_match("/[A-Z0-9]{8,12}/", $this->container['bic'])) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be conform to the pattern "%s".',
                'bic',
                "/[A-Z0-9]{8,12}/"
        ...
        if (! is_null($this->container['iban']) && (mb_strlen($this->container['iban']) < 4)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be bigger than or equal to %d.',
                'iban',
                4
        ...
        if (! is_null($this->container['iban']) && ! preg_match("/[A-Z0-9]{4,34}/", $this->container['iban'])) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be conform to the pattern "%s".',
                'iban',
                "/[A-Z0-9]{4,34}/"
        ...
        if ($this->container['accountName'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'accountName');
        }
        if ((mb_strlen($this->container['accountName']) > 40)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be smaller than or equal to %d.',
                'accountName',
                40
        ...
        if ((mb_strlen($this->container['accountName']) < 0)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be bigger than or equal to %d.',
                'accountName',
                0
        ...
        if (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{,40}/", $this->container['accountName'])) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be conform to the pattern "%s".',
                'accountName',
                "/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{,40}/"
    ...
    {
        return $this->get('sortCode');
    }

    /**
     * Sets sortCode
     *
     * @param string|null $sortCode Sort code for the account. Will only be specified for accounts in the UK.
     *
     * @return $this
     */
    public function setSortCode($sortCode)
    {
        if (! is_null($sortCode) && (mb_strlen($sortCode) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sortCode when calling PaymentDetailsAccount., must be smaller than or equal to 6.');
        }
        if (! is_null($sortCode) && (mb_strlen($sortCode) < 6)) {
            throw new \InvalidArgumentException('invalid length for $sortCode when calling PaymentDetailsAccount., must be bigger than or equal to 6.');
        }
        if (! is_null($sortCode) && (! preg_match("/\\d{6}/", $sortCode))) {
            throw new \InvalidArgumentException("invalid value for $sortCode when calling PaymentDetailsAccount., must conform to the pattern /\\d{6}/.");
        }
     ...
     * Sets accountNumber
     *
     * @param string|null $accountNumber Account number for the account. This will be the UK account number for UK based accounts, it may also contain foreign account numbers for payments originating overseas such as the USA.
     *
     * @return $this
     */
    public function setAccountNumber($accountNumber)
    {
        if (! is_null($accountNumber) && (mb_strlen($accountNumber) > 34)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling PaymentDetailsAccount., must be smaller than or equal to 34.');
        }
        if (! is_null($accountNumber) && (mb_strlen($accountNumber) < 0)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling PaymentDetailsAccount., must be bigger than or equal to 0.');
        }
        if (! is_null($accountNumber) && (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{,34}/", $accountNumber))) {
            throw new \InvalidArgumentException("invalid value for $accountNumber when calling PaymentDetailsAccount., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{,34}/.");
        }
     ...
     * Sets bic
     *
     * @param string|null $bic Business identifier code for the account. This may be present for payments originating overseas.
     *
     * @return $this
     */
    public function setBic($bic)
    {
        if (! is_null($bic) && (mb_strlen($bic) > 12)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling PaymentDetailsAccount., must be smaller than or equal to 12.');
        }
        if (! is_null($bic) && (mb_strlen($bic) < 8)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling PaymentDetailsAccount., must be bigger than or equal to 8.');
        }
        if (! is_null($bic) && (! preg_match("/[A-Z0-9]{8,12}/", $bic))) {
            throw new \InvalidArgumentException("invalid value for $bic when calling PaymentDetailsAccount., must conform to the pattern /[A-Z0-9]{8,12}/.");
        }
     ...
     * Sets iban
     *
     * @param string|null $iban International bank account number for the account. This may be present for payments originating overseas.
     *
     * @return $this
     */
    public function setIban($iban)
    {
        if (! is_null($iban) && (mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling PaymentDetailsAccount., must be smaller than or equal to 34.');
        }
        if (! is_null($iban) && (mb_strlen($iban) < 4)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling PaymentDetailsAccount., must be bigger than or equal to 4.');
        }
        if (! is_null($iban) && (! preg_match("/[A-Z0-9]{4,34}/", $iban))) {
            throw new \InvalidArgumentException("invalid value for $iban when calling PaymentDetailsAccount., must conform to the pattern /[A-Z0-9]{4,34}/.");
        }
     ...
     * Sets accountName
     *
     * @param string $accountName Name of the account (not always the account holder)
     *
     * @return $this
     */
    public function setAccountName($accountName)
    {
        if ((mb_strlen($accountName) > 40)) {
            throw new \InvalidArgumentException('invalid length for $accountName when calling PaymentDetailsAccount., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($accountName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $accountName when calling PaymentDetailsAccount., must be bigger than or equal to 0.');
        }
        if ((! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{,40}/", $accountName))) {
            throw new \InvalidArgumentException("invalid value for $accountName when calling PaymentDetailsAccount., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{,40}/.");
        }
