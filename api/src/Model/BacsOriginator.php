...
/**
 * BacsOriginator Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class BacsOriginator implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BacsOriginator';
    ...
    protected static $setters = [
        'originatorUid' => 'setOriginatorUid',
    ...
    protected static $getters = [
        'originatorUid' => 'getOriginatorUid',
    ...
    {
        $this->container['originatorUid'] = $data['originatorUid'] ?? null;
        $this->container['serviceUserNumber'] = $data['serviceUserNumber'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (! is_null($this->container['serviceUserNumber']) && (mb_strlen($this->container['serviceUserNumber']) > 6)) {
        ...
        if (! is_null($this->container['name']) && (mb_strlen($this->container['name']) > 33)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be smaller than or equal to %d.',
                'name',
                33
     ...
     * @return string|null
     */
    public function getOriginatorUid()
    {
        return $this->get('originatorUid');
    }

    /**
     * Sets originatorUid
     *
     * @param string|null $originatorUid Starling's unique identifier of the originator
     *
     * @return $this
     */
    public function setOriginatorUid($originatorUid)
    {
        $this->container['originatorUid'] = $originatorUid;
     ...
     * @return string|null
     */
    public function getServiceUserNumber()
    {
        return $this->get('serviceUserNumber');
    }

    /**
     * Sets serviceUserNumber
     *
     * @param string|null $serviceUserNumber BACS's unique identifier of the originator
     *
     * @return $this
     */
    public function setServiceUserNumber($serviceUserNumber)
    {
        if (! is_null($serviceUserNumber) && (mb_strlen($serviceUserNumber) > 6)) {
            throw new \InvalidArgumentException('invalid length for $serviceUserNumber when calling BacsOriginator., must be smaller than or equal to 6.');
        }
        if (! is_null($serviceUserNumber) && (mb_strlen($serviceUserNumber) < 6)) {
            throw new \InvalidArgumentException('invalid length for $serviceUserNumber when calling BacsOriginator., must be bigger than or equal to 6.');
        }
     ...
     * Sets name
     *
     * @param string|null $name The name of the originator as registered with BACS
     *
     * @return $this
     */
    public function setName($name)
    {
        if (! is_null($name) && (mb_strlen($name) > 33)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BacsOriginator., must be smaller than or equal to 33.');
        }
        if (! is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BacsOriginator., must be bigger than or equal to 0.');
        }
     ...
     * Sets sortCode
     *
     * @param string|null $sortCode The sort code of the originator as registered with BACS
     *
     * @return $this
     */
    public function setSortCode($sortCode)
    {
        if (! is_null($sortCode) && (mb_strlen($sortCode) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sortCode when calling BacsOriginator., must be smaller than or equal to 6.');
        }
        if (! is_null($sortCode) && (mb_strlen($sortCode) < 6)) {
            throw new \InvalidArgumentException('invalid length for $sortCode when calling BacsOriginator., must be bigger than or equal to 6.');
        }
     ...
     * Sets accountNumber
     *
     * @param string|null $accountNumber The account number of the originator as registered with BACS
     *
     * @return $this
     */
    public function setAccountNumber($accountNumber)
    {
        if (! is_null($accountNumber) && (mb_strlen($accountNumber) > 8)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling BacsOriginator., must be smaller than or equal to 8.');
        }
        if (! is_null($accountNumber) && (mb_strlen($accountNumber) < 8)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling BacsOriginator., must be bigger than or equal to 8.');
        }
