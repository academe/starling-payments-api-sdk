...
class PaymentAccount implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'createdAt' => '\DateTime',
        'description' => 'string',
        'balance' => '\Academe\Starling\PaymentsSdk\Model\Balance'
    ];
     ...
     * @return string[]
     */
    public function getAccountHolderAllowableValues()
    {
        return [
            self::ACCOUNT_HOLDER_PAYMENT_BUSINESS,
            self::ACCOUNT_HOLDER_AGENCY,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['accountHolder'] = $data['accountHolder'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accountHolder'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'accountHolder');
        }
        $allowedValues = $this->getAccountHolderAllowableValues();
        if (!is_null($this->container['accountHolder']) && !in_array($this->container['accountHolder'], $allowedValues, true)) {
    ...
    {
        return $this->get('accountHolder');
    }

    /**
     * Sets accountHolder
     *
     * @param string $accountHolder Type of the account holder, currently only AGENCY is supported
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getAccountHolderAllowableValues();
        if (!in_array($accountHolder, $allowedValues, true)) {
     ...
     * Sets description
     *
     * @param string|null $description Description of the account, for reference
     *
     * @return $this
     */
     ...
     * Gets balance
     *
     * @return \Academe\Starling\PaymentsSdk\Model\Balance|null
     */
     ...
     * Sets balance
     *
     * @param \Academe\Starling\PaymentsSdk\Model\Balance|null $balance balance
     *
     * @return $this
     */
