...
/**
 * PaymentRejectionReason Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PaymentRejectionReason implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentRejectionReason';
     ...
     * Sets code
     *
     * @param string|null $code Unique identifier of the reason for rejection
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description Human-readable description of the rejection reason
     *
     * @return $this
     */
