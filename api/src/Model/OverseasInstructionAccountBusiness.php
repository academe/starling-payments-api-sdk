...
/**
 * OverseasInstructionAccountBusiness Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OverseasInstructionAccountBusiness implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OverseasInstructionAccountBusiness';
    ...
    {
        $this->container['businessName'] = $data['businessName'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['businessName'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'businessName');
        }
        if ((mb_strlen($this->container['businessName']) > 40)) {
        ...
        if ((mb_strlen($this->container['businessName']) < 0)) {
            $invalidProperties[] = sprintf(
        ...
        if (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/", $this->container['businessName'])) {
            $invalidProperties[] = sprintf(
     ...
     * Sets businessName
     *
     * @param string $businessName Name of originating account holder business
     *
     * @return $this
     */
    public function setBusinessName($businessName)
    {
        if ((mb_strlen($businessName) > 40)) {
            throw new \InvalidArgumentException('invalid length for $businessName when calling OverseasInstructionAccountBusiness., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($businessName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $businessName when calling OverseasInstructionAccountBusiness., must be bigger than or equal to 0.');
        }
        if ((! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/", $businessName))) {
            throw new \InvalidArgumentException("invalid value for $businessName when calling OverseasInstructionAccountBusiness., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/.");
        }
