...
class PaymentDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'rejectedReason' => '\Academe\Starling\PaymentsSdk\Model\PaymentRejectionReason',
    ...
    protected static $setters = [
        ...
        'status' => 'setStatus',
        'rejectedReason' => 'setRejectedReason',
    ...
    const DIRECTION_OUTBOUND = 'OUTBOUND';const STATUS_PENDING = 'PENDING';
    const STATUS_ACCEPTED = 'ACCEPTED';
    const STATUS_REJECTED = 'REJECTED';
    const STATUS_REVERSED = 'REVERSED';const TYPE_SIP = 'SIP';
    const TYPE_SOP = 'SOP';
    const TYPE_FDP = 'FDP';
    const TYPE_SRN = 'SRN';
    const TYPE_RTN = 'RTN';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rejectedReason'] = $data['rejectedReason'] ?? null;
        $this->container['requestedAt'] = $data['requestedAt'] ?? null;
     ...
     *
     * @param string|null $paymentBusinessUid Unique identifier of the company requesting or receiving the payment
     *
     * @return $this
     */
     ...
     *
     * @param string|null $paymentAccountUid Unique identifier of the account containing the funds sent or received
     *
     * @return $this
     */
     ...
     * Sets addressUid
     *
     * @param string|null $addressUid Unique identifier of the address the payment was sent from or received to
     *
     * @return $this
     */
     ...
     * Sets direction
     *
     * @param string|null $direction The direction of the payment
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the payment request
     *
     * @return $this
     */
     ...
     * Gets rejectedReason
     *
     * @return \Academe\Starling\PaymentsSdk\Model\PaymentRejectionReason|null
     */
     ...
     * Sets rejectedReason
     *
     * @param \Academe\Starling\PaymentsSdk\Model\PaymentRejectionReason|null $rejectedReason rejectedReason
     *
     * @return $this
     */
    public function setRejectedReason($rejectedReason)
    {
        $this->container['rejectedReason'] = $rejectedReason;
     ...
     * Sets requestedAt
     *
     * @param \DateTime|null $requestedAt Date and time that the request for payment was originally received
     *
     * @return $this
     */
