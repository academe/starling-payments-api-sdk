...
/**
 * CancelMandateRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class CancelMandateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelMandateRequest';
    ...
    protected static $openAPITypes = [
        'mandateStatusCancellationReason' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'mandateStatusCancellationReason' => null
    ];
    ...
    protected static $attributeMap = [
        'mandateStatusCancellationReason' => 'mandateStatusCancellationReason'
    ];
    ...
    protected static $setters = [
        'mandateStatusCancellationReason' => 'setMandateStatusCancellationReason'
    ];
    ...
    protected static $getters = [
        'mandateStatusCancellationReason' => 'getMandateStatusCancellationReason'
    ];
    ...
    const MANDATE_STATUS_CANCELLATION_REASON_INSTRUCTION_CANCELLED = 'INSTRUCTION_CANCELLED';
    const MANDATE_STATUS_CANCELLATION_REASON_INSTRUCTION_CANCELLED_BY_PAYER = 'INSTRUCTION_CANCELLED_BY_PAYER';
    const MANDATE_STATUS_CANCELLATION_REASON_DECEASED = 'DECEASED';
    const MANDATE_STATUS_CANCELLATION_REASON_SWITCHED = 'SWITCHED';
    const MANDATE_STATUS_CANCELLATION_REASON_ACCOUNT_CLOSED = 'ACCOUNT_CLOSED';
    const MANDATE_STATUS_CANCELLATION_REASON_ACCOUNT_TRANSFERRED_TO_NEW_BRANCH = 'ACCOUNT_TRANSFERRED_TO_NEW_BRANCH';
    const MANDATE_STATUS_CANCELLATION_REASON_NOTICE_DISPUTED = 'NOTICE_DISPUTED';
    const MANDATE_STATUS_CANCELLATION_REASON_INSTRUCTION_AMENDED = 'INSTRUCTION_AMENDED';
     ...
     * @return string[]
     */
    public function getMandateStatusCancellationReasonAllowableValues()
    {
        return [
            self::MANDATE_STATUS_CANCELLATION_REASON_INSTRUCTION_CANCELLED,
            self::MANDATE_STATUS_CANCELLATION_REASON_INSTRUCTION_CANCELLED_BY_PAYER,
            self::MANDATE_STATUS_CANCELLATION_REASON_DECEASED,
            self::MANDATE_STATUS_CANCELLATION_REASON_SWITCHED,
            self::MANDATE_STATUS_CANCELLATION_REASON_ACCOUNT_CLOSED,
            self::MANDATE_STATUS_CANCELLATION_REASON_ACCOUNT_TRANSFERRED_TO_NEW_BRANCH,
            self::MANDATE_STATUS_CANCELLATION_REASON_NOTICE_DISPUTED,
            self::MANDATE_STATUS_CANCELLATION_REASON_INSTRUCTION_AMENDED,
        ];
    }
    ...
    {
        $this->container['mandateStatusCancellationReason'] = $data['mandateStatusCancellationReason'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mandateStatusCancellationReason'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'mandateStatusCancellationReason');
        }
        $allowedValues = $this->getMandateStatusCancellationReasonAllowableValues();
        if (!is_null($this->container['mandateStatusCancellationReason']) && !in_array($this->container['mandateStatusCancellationReason'], $allowedValues, true)) {
    ...
    /**
     * Gets mandateStatusCancellationReason
     *
     * @return string
     */
    public function getMandateStatusCancellationReason()
    {
        return $this->get('mandateStatusCancellationReason');
    }

    /**
     * Sets mandateStatusCancellationReason
     *
     * @param string $mandateStatusCancellationReason The reason that the mandate was cancelled.
     *
     * @return $this
     */
    public function setMandateStatusCancellationReason($mandateStatusCancellationReason)
    {
        $allowedValues = $this->getMandateStatusCancellationReasonAllowableValues();
        if (!in_array($mandateStatusCancellationReason, $allowedValues, true)) {
        ...
        $this->container['mandateStatusCancellationReason'] = $mandateStatusCancellationReason;
