...
class Balance implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @return string[]
     */
    public function getBalanceStateAllowableValues()
    {
        return [
            self::BALANCE_STATE_IN_CREDIT,
            self::BALANCE_STATE_OVERDRAWN,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['balanceState'] = $data['balanceState'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getBalanceStateAllowableValues();
        if (!is_null($this->container['balanceState']) && !in_array($this->container['balanceState'], $allowedValues, true)) {
     ...
     *
     * @param \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount|null $currencyAndAmount currencyAndAmount
     *
     * @return $this
     */
    ...
    {
        return $this->get('balanceState');
    }

    /**
     * Sets balanceState
     *
     * @param string|null $balanceState State of the balance on the account, either 'IN_CREDIT' where money is being held at on behalf of the account holder or 'OVERDRAWN' when money is being borrowed
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getBalanceStateAllowableValues();
        if (! is_null($balanceState) && !in_array($balanceState, $allowedValues, true)) {
        ...
        $this->container['balanceState'] = $balanceState;
