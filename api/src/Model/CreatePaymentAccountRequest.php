...
/**
 * CreatePaymentAccountRequest Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreatePaymentAccountRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentAccountRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['description'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'description');
        }
     ...
     * Sets description
     *
     * @param string $description Description of the account, for internal reference
     *
     * @return $this
     */
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 100)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreatePaymentAccountRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreatePaymentAccountRequest., must be bigger than or equal to 0.');
        }
