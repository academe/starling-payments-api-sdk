...
/**
 * DirectCreditPaymentReceivedNotification Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DirectCreditPaymentReceivedNotification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DirectCreditPaymentReceivedNotification';
     ...
     * Sets bacsPaymentUid
     *
     * @param string|null $bacsPaymentUid Unique identifier of the direct credit payment
     *
     * @return $this
     */
    ...
    public function setReference($reference)
    {
        if (! is_null($reference) && (mb_strlen($reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling DirectCreditPaymentReceivedNotification., must be smaller than or equal to 18.');
        }
        if (! is_null($reference) && (mb_strlen($reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling DirectCreditPaymentReceivedNotification., must be bigger than or equal to 0.');
        }
     ...
     * Sets receivedAt
     *
     * @param \DateTime|null $receivedAt Time at which the payment was credited to the account
     *
     * @return $this
     */
