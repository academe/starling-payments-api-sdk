...
/**
 * MandateCreatedNotification Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class MandateCreatedNotification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MandateCreatedNotification';
     ...
     *
     * @param string|null $paymentBusinessUid Unique identifier of the company for whom the mandate has been created
     *
     * @return $this
     */
     ...
     *
     * @param string|null $paymentAccountUid Unique identifier of the account for which payments for the mandate will be taken
     *
     * @return $this
     */
     ...
     * Sets mandateUid
     *
     * @param string|null $mandateUid Unique identifier of the mandate that has been created
     *
     * @return $this
     */
    ...
    public function setReference($reference)
    {
        if (! is_null($reference) && (mb_strlen($reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling MandateCreatedNotification., must be smaller than or equal to 18.');
        }
        if (! is_null($reference) && (mb_strlen($reference) < 6)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling MandateCreatedNotification., must be bigger than or equal to 6.');
        }
     ...
     * Sets receivedAt
     *
     * @param \DateTime|null $receivedAt Time at which the mandate was registered with Starling
     *
     * @return $this
     */
