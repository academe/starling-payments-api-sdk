...
/**
 * AddressBacsStatus Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class AddressBacsStatus implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddressBacsStatus';
     ...
     *
     * @param string|null $directCreditPaymentsStatus Indicates if the account has been allowed by the account owner to receive direct credit payments, if disabled then all direct credit payments to this account will be rejected
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDirectCreditPaymentsStatusAllowableValues();
        if (! is_null($directCreditPaymentsStatus) && !in_array($directCreditPaymentsStatus, $allowedValues, true)) {
     ...
     *
     * @param string|null $directDebitPaymentsStatus Indicates if the account has been allowed by the account owner to make direct debit payments, if disabled then all attempts to collect direct debit payments and mandates from this account will be rejected
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDirectDebitPaymentsStatusAllowableValues();
        if (! is_null($directDebitPaymentsStatus) && !in_array($directDebitPaymentsStatus, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    'Invalid value for "%s", must be one of "%s"',
                    'directDebitPaymentsStatus',
