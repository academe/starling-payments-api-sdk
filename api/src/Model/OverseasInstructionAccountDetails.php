...
/**
 * OverseasInstructionAccountDetails Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OverseasInstructionAccountDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OverseasInstructionAccountDetails';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bic'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'bic');
        }
        ...
        if (! preg_match("/^[0-9A-Z]{8}$|^[0-9A-Z]{11}/", $this->container['bic'])) {
            $invalidProperties[] = sprintf(
        ...
        if (! is_null($this->container['accountNumber']) && ! preg_match("/\\w{1,34}/", $this->container['accountNumber'])) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be conform to the pattern "%s".',
                'accountNumber',
                "/\\w{1,34}/"
        ...
        if (! is_null($this->container['iban']) && ! preg_match("/\\w{1,34}/", $this->container['iban'])) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be conform to the pattern "%s".',
                'iban',
                "/\\w{1,34}/"
     ...
     * Sets bic
     *
     * @param string $bic ISO 9362 BIC code
     *
     * @return $this
     */
    ...
    {
        if ((mb_strlen($bic) > 11)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling OverseasInstructionAccountDetails., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($bic) < 8)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling OverseasInstructionAccountDetails., must be bigger than or equal to 8.');
        }
        if ((! preg_match("/^[0-9A-Z]{8}$|^[0-9A-Z]{11}/", $bic))) {
            throw new \InvalidArgumentException("invalid value for $bic when calling OverseasInstructionAccountDetails., must conform to the pattern /^[0-9A-Z]{8}$|^[0-9A-Z]{11}/.");
        }
     ...
     * Sets accountNumber
     *
     * @param string|null $accountNumber Account number, if any. Either this or iban is required.
     *
     * @return $this
     */
    public function setAccountNumber($accountNumber)
    {
        if (! is_null($accountNumber) && (mb_strlen($accountNumber) > 34)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling OverseasInstructionAccountDetails., must be smaller than or equal to 34.');
        }
        if (! is_null($accountNumber) && (mb_strlen($accountNumber) < 0)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling OverseasInstructionAccountDetails., must be bigger than or equal to 0.');
        }
        if (! is_null($accountNumber) && (! preg_match("/\\w{1,34}/", $accountNumber))) {
            throw new \InvalidArgumentException("invalid value for $accountNumber when calling OverseasInstructionAccountDetails., must conform to the pattern /\\w{1,34}/.");
        }
     ...
     * Sets iban
     *
     * @param string|null $iban Account IBAN, if any. Either this or iban is required.
     *
     * @return $this
     */
    public function setIban($iban)
    {
        if (! is_null($iban) && (mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling OverseasInstructionAccountDetails., must be smaller than or equal to 34.');
        }
        if (! is_null($iban) && (mb_strlen($iban) < 0)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling OverseasInstructionAccountDetails., must be bigger than or equal to 0.');
        }
        if (! is_null($iban) && (! preg_match("/\\w{1,34}/", $iban))) {
            throw new \InvalidArgumentException("invalid value for $iban when calling OverseasInstructionAccountDetails., must conform to the pattern /\\w{1,34}/.");
        }
