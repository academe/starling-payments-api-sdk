...
/**
 * DirectDebitPaymentPaidNotification Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DirectDebitPaymentPaidNotification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DirectDebitPaymentPaidNotification';
     ...
     *
     * @param string|null $paymentAccountUid Unique identifier of the account from which the funds were taken
     *
     * @return $this
     */
     ...
     * Sets addressUid
     *
     * @param string|null $addressUid Unique identifier of the address the payment was taken from
     *
     * @return $this
     */
     ...
     * Sets mandateUid
     *
     * @param string|null $mandateUid Unique identifier of the mandate under which the payment was taken
     *
     * @return $this
     */
    ...
    public function setReference($reference)
    {
        if (! is_null($reference) && (mb_strlen($reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling DirectDebitPaymentPaidNotification., must be smaller than or equal to 18.');
        }
        if (! is_null($reference) && (mb_strlen($reference) < 6)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling DirectDebitPaymentPaidNotification., must be bigger than or equal to 6.');
        }
     ...
     * Sets receivedAt
     *
     * @param \DateTime|null $receivedAt Time at which the payment was debited from the account
     *
     * @return $this
     */
