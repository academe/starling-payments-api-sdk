...
/**
 * ChangeStatusPaymentAccountAddressRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ChangeStatusPaymentAccountAddressRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangeStatusPaymentAccountAddressRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['status'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'status');
        }
     ...
     * Sets status
     *
     * @param string $status New status for the account address
     *
     * @return $this
     */
