...
/**
 * PaymentOriginatingOverseasSanctionFailedNotification Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PaymentOriginatingOverseasSanctionFailedNotification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentOriginatingOverseasSanctionFailedNotification';
     ...
     *
     * @param string|null $paymentAccountUid Unique identifier of the payment account
     *
     * @return $this
     */
     ...
     *
     * @param string|null $paymentBusinessUid Unique identifier of the payment business
     *
     * @return $this
     */
