...
/**
 * PaymentOriginatingOverseasInboundReturnNotification Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PaymentOriginatingOverseasInboundReturnNotification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentOriginatingOverseasInboundReturnNotification';
    ...
    public function setReference($reference)
    {
        if (! is_null($reference) && (mb_strlen($reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling PaymentOriginatingOverseasInboundReturnNotification., must be smaller than or equal to 18.');
        }
        if (! is_null($reference) && (mb_strlen($reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling PaymentOriginatingOverseasInboundReturnNotification., must be bigger than or equal to 0.');
        }
    ...
    public function setAdditionalRemittanceInformation($additionalRemittanceInformation)
    {
        if (! is_null($additionalRemittanceInformation) && (mb_strlen($additionalRemittanceInformation) > 140)) {
            throw new \InvalidArgumentException('invalid length for $additionalRemittanceInformation when calling PaymentOriginatingOverseasInboundReturnNotification., must be smaller than or equal to 140.');
        }
        if (! is_null($additionalRemittanceInformation) && (mb_strlen($additionalRemittanceInformation) < 0)) {
            throw new \InvalidArgumentException('invalid length for $additionalRemittanceInformation when calling PaymentOriginatingOverseasInboundReturnNotification., must be bigger than or equal to 0.');
        }
        if (! is_null($additionalRemittanceInformation) && (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,140}/", $additionalRemittanceInformation))) {
            throw new \InvalidArgumentException("invalid value for $additionalRemittanceInformation when calling PaymentOriginatingOverseasInboundReturnNotification., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,140}/.");
        }
