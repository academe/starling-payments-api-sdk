...
/**
 * DomesticPaymentInstructionRequest Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DomesticPaymentInstructionRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomesticPaymentInstructionRequest';
    ...
    protected static $openAPITypes = [
        'domesticInstructionAccount' => '\Academe\Starling\PaymentsSdk\Model\DomesticInstructionAccount',
        'reference' => 'string',
        'additionalRemittanceInformation' => 'string',
        'currencyAndAmount' => '\Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount',
        'type' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'domesticInstructionAccount' => null,
        'reference' => null,
    ...
    protected static $setters = [
        'domesticInstructionAccount' => 'setDomesticInstructionAccount',
        'reference' => 'setReference',
        'additionalRemittanceInformation' => 'setAdditionalRemittanceInformation',
        'currencyAndAmount' => 'setCurrencyAndAmount',
        'type' => 'setType'
    ];
    ...
    protected static $getters = [
        'domesticInstructionAccount' => 'getDomesticInstructionAccount',
        'reference' => 'getReference',
        'additionalRemittanceInformation' => 'getAdditionalRemittanceInformation',
        'currencyAndAmount' => 'getCurrencyAndAmount',
        'type' => 'getType'
    ];
    ...
    {
        $this->container['domesticInstructionAccount'] = $data['domesticInstructionAccount'] ?? null;
        $this->container['reference'] = $data['reference'] ?? null;
        $this->container['additionalRemittanceInformation'] = $data['additionalRemittanceInformation'] ?? null;
        $this->container['currencyAndAmount'] = $data['currencyAndAmount'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['domesticInstructionAccount'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'domesticInstructionAccount');
        }
        ...
        if ($this->container['currencyAndAmount'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'currencyAndAmount');
        }
    ...
    /**
     * Gets domesticInstructionAccount
     *
     * @return \Academe\Starling\PaymentsSdk\Model\DomesticInstructionAccount
     */
    public function getDomesticInstructionAccount()
    {
        return $this->get('domesticInstructionAccount');
    }

    /**
     * Sets domesticInstructionAccount
     *
     * @param \Academe\Starling\PaymentsSdk\Model\DomesticInstructionAccount $domesticInstructionAccount domesticInstructionAccount
     *
     * @return $this
     */
    public function setDomesticInstructionAccount($domesticInstructionAccount)
    {
        $this->container['domesticInstructionAccount'] = $domesticInstructionAccount;
    ...
    public function setReference($reference)
    {
        if ((mb_strlen($reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling DomesticPaymentInstructionRequest., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($reference) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling DomesticPaymentInstructionRequest., must be bigger than or equal to 1.');
        }
        if ((! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,18}/", $reference))) {
            throw new \InvalidArgumentException("invalid value for $reference when calling DomesticPaymentInstructionRequest., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,18}/.");
        }
    ...
    public function setAdditionalRemittanceInformation($additionalRemittanceInformation)
    {
        if (! is_null($additionalRemittanceInformation) && (mb_strlen($additionalRemittanceInformation) > 140)) {
            throw new \InvalidArgumentException('invalid length for $additionalRemittanceInformation when calling DomesticPaymentInstructionRequest., must be smaller than or equal to 140.');
        }
        if (! is_null($additionalRemittanceInformation) && (mb_strlen($additionalRemittanceInformation) < 0)) {
            throw new \InvalidArgumentException('invalid length for $additionalRemittanceInformation when calling DomesticPaymentInstructionRequest., must be bigger than or equal to 0.');
        }
        if (! is_null($additionalRemittanceInformation) && (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,140}/", $additionalRemittanceInformation))) {
            throw new \InvalidArgumentException("invalid value for $additionalRemittanceInformation when calling DomesticPaymentInstructionRequest., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{0,140}/.");
        }
    ...
    /**
     * Gets currencyAndAmount
     *
     * @return \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount
     */
    public function getCurrencyAndAmount()
    {
        return $this->get('currencyAndAmount');
    }

    /**
     * Sets currencyAndAmount
     *
     * @param \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount $currencyAndAmount currencyAndAmount
     *
     * @return $this
     */
    public function setCurrencyAndAmount($currencyAndAmount)
    {
        $this->container['currencyAndAmount'] = $currencyAndAmount;
