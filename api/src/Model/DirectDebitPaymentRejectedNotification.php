...
/**
 * DirectDebitPaymentRejectedNotification Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DirectDebitPaymentRejectedNotification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DirectDebitPaymentRejectedNotification';
    ...
    protected static $openAPITypes = [
        ...
        'mandateUid' => 'string',
        'bacsOriginator' => '\Academe\Starling\PaymentsSdk\Model\BacsOriginator',
        'reference' => 'string',
    ...
    protected static $setters = [
        ...
        'bacsOriginator' => 'setBacsOriginator',
    ...
    protected static $getters = [
        ...
        'bacsOriginator' => 'getBacsOriginator',
    ...
    const REJECTION_REASON_ACCOUNT_INSUFFICIENT_FUNDS = 'ACCOUNT_INSUFFICIENT_FUNDS';
    const REJECTION_REASON_INSTRUCTED_INSUFFICIENT_FUNDS = 'INSTRUCTED_INSUFFICIENT_FUNDS';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bacsOriginator'] = $data['bacsOriginator'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (! is_null($this->container['reference']) && (mb_strlen($this->container['reference']) < 6)) {
            $invalidProperties[] = sprintf(
     ...
     *
     * @param string|null $paymentBusinessUid Unique identifier of the company that attempted to make the payment
     *
     * @return $this
     */
     ...
     *
     * @param string|null $paymentAccountUid Unique identifier of the account from which the attempt to take the funds was made
     *
     * @return $this
     */
     ...
     * Sets addressUid
     *
     * @param string|null $addressUid Unique identifier of the address from which the attempt to make the payment was made
     *
     * @return $this
     */
     ...
     * Sets bacsPaymentUid
     *
     * @param string|null $bacsPaymentUid Unique identifier of the direct debit payment
     *
     * @return $this
     */
     ...
     * Sets mandateUid
     *
     * @param string|null $mandateUid Unique identifier of the mandate under which it was intended that the payment was taken
     *
     * @return $this
     */
     ...
     * Gets bacsOriginator
     *
     * @return \Academe\Starling\PaymentsSdk\Model\BacsOriginator|null
     */
    public function getBacsOriginator()
    {
        return $this->get('bacsOriginator');
    }

    /**
     * Sets bacsOriginator
     *
     * @param \Academe\Starling\PaymentsSdk\Model\BacsOriginator|null $bacsOriginator bacsOriginator
     *
     * @return $this
     */
    public function setBacsOriginator($bacsOriginator)
    {
        $this->container['bacsOriginator'] = $bacsOriginator;
    ...
    public function setReference($reference)
    {
        if (! is_null($reference) && (mb_strlen($reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling DirectDebitPaymentRejectedNotification., must be smaller than or equal to 18.');
        }
        if (! is_null($reference) && (mb_strlen($reference) < 6)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling DirectDebitPaymentRejectedNotification., must be bigger than or equal to 6.');
        }
     ...
     *
     * @param string|null $rejectionReason Reason for rejection of payment; ACCOUNT_INSUFFICIENT_FUNDS means the account owning the address had insufficient funds to make the payment; INSTRUCTED_INSUFFICIENT_FUNDS means that payment was instructed to not be paid due to insufficient customer funds
     *
     * @return $this
     */
     ...
     * Sets cancelledAt
     *
     * @param \DateTime|null $cancelledAt Time at which Starling stopped attempting to take the payment from the account
     *
     * @return $this
     */
