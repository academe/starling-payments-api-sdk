...
/**
 * ChangeFasterPaymentsStatusPaymentAccountAddressRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ChangeFasterPaymentsStatusPaymentAccountAddressRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangeFasterPaymentsStatusPaymentAccountAddressRequest';
    ...
    protected static $setters = [
        'inboundStatus' => 'setInboundStatus',
        'outboundStatus' => 'setOutboundStatus'
    ];
    ...
    const INBOUND_STATUS_ENABLED = 'ENABLED';
    const INBOUND_STATUS_DISABLED = 'DISABLED';const OUTBOUND_STATUS_ENABLED = 'ENABLED';
    const OUTBOUND_STATUS_DISABLED = 'DISABLED';
     ...
     * @return string[]
     */
    public function getInboundStatusAllowableValues()
    {
        return [
            self::INBOUND_STATUS_ENABLED,
            self::INBOUND_STATUS_DISABLED,
        ];
    }
     ...
     * @return string[]
     */
    public function getOutboundStatusAllowableValues()
    {
        return [
            self::OUTBOUND_STATUS_ENABLED,
            self::OUTBOUND_STATUS_DISABLED,
        ];
    }
    ...
    {
        $this->container['inboundStatus'] = $data['inboundStatus'] ?? null;
        $this->container['outboundStatus'] = $data['outboundStatus'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inboundStatus'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'inboundStatus');
        }
        $allowedValues = $this->getInboundStatusAllowableValues();
        if (!is_null($this->container['inboundStatus']) && !in_array($this->container['inboundStatus'], $allowedValues, true)) {
        ...
        if ($this->container['outboundStatus'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'outboundStatus');
        }
        $allowedValues = $this->getOutboundStatusAllowableValues();
        if (!is_null($this->container['outboundStatus']) && !in_array($this->container['outboundStatus'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be one of "%s"',
                'outboundStatus',
                implode('", "', $allowedValues)
    ...
    {
        return $this->get('inboundStatus');
    }

    /**
     * Sets inboundStatus
     *
     * @param string $inboundStatus New status for inbound faster payments
     *
     * @return $this
     */
    public function setInboundStatus($inboundStatus)
    {
        $allowedValues = $this->getInboundStatusAllowableValues();
        if (!in_array($inboundStatus, $allowedValues, true)) {
        ...
        $this->container['inboundStatus'] = $inboundStatus;
    ...
    {
        return $this->get('outboundStatus');
    }

    /**
     * Sets outboundStatus
     *
     * @param string $outboundStatus New status for outbound faster payments
     *
     * @return $this
     */
    public function setOutboundStatus($outboundStatus)
    {
        $allowedValues = $this->getOutboundStatusAllowableValues();
        if (!in_array($outboundStatus, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    'Invalid value for "%s", must be one of "%s"',
                    'outboundStatus',
        ...
        $this->container['outboundStatus'] = $outboundStatus;
