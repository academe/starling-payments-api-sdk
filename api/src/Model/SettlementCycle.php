...
/**
 * SettlementCycle Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class SettlementCycle implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SettlementCycle';
    ...
    protected static $openAPITypes = [
        ...
        'startTime' => '\DateTime',
        'endTime' => '\DateTime',
        'netPayment' => '\Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount',
        'netDirection' => 'string',
        'inboundCount' => 'int',
        'outboundCount' => 'int'
    ];
    ...
    protected static $setters = [
        ...
        'netDirection' => 'setNetDirection',
        'inboundCount' => 'setInboundCount',
        'outboundCount' => 'setOutboundCount'
    ];
    ...
    const NET_DIRECTION_INBOUND = 'INBOUND';
    const NET_DIRECTION_OUTBOUND = 'OUTBOUND';
     ...
     * @return string[]
     */
    public function getNetDirectionAllowableValues()
    {
        return [
            self::NET_DIRECTION_INBOUND,
            self::NET_DIRECTION_OUTBOUND,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['netPayment'] = $data['netPayment'] ?? null;
        $this->container['netDirection'] = $data['netDirection'] ?? null;
        $this->container['inboundCount'] = $data['inboundCount'] ?? null;
        $this->container['outboundCount'] = $data['outboundCount'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getNetDirectionAllowableValues();
        if (!is_null($this->container['netDirection']) && !in_array($this->container['netDirection'], $allowedValues, true)) {
     ...
     *
     * @param string|null $settlementCycleUid Unique identifier of the settlement cycle
     *
     * @return $this
     */
     ...
     * Sets startTime
     *
     * @param \DateTime|null $startTime Start date and time of the cycle
     *
     * @return $this
     */
     ...
     * Sets endTime
     *
     * @param \DateTime|null $endTime Start date and time of the cycle
     *
     * @return $this
     */
    ...
    {
        return $this->get('netPayment');
    }

    /**
     * Sets netPayment
     *
     * @param \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount|null $netPayment netPayment
     *
     * @return $this
     */
    public function setNetPayment($netPayment)
    {
     ...
     * @return string|null
     */
    public function getNetDirection()
    {
        return $this->get('netDirection');
    }

    /**
     * Sets netDirection
     *
     * @param string|null $netDirection Net direction of movements during this period
     *
     * @return $this
     */
    public function setNetDirection($netDirection)
    {
        $allowedValues = $this->getNetDirectionAllowableValues();
        if (! is_null($netDirection) && !in_array($netDirection, $allowedValues, true)) {
        ...
        $this->container['netDirection'] = $netDirection;
    ...
    {
        return $this->get('inboundCount');
    }

    /**
     * Sets inboundCount
     *
     * @param int|null $inboundCount Number of inbound payments received during the cycle
     *
     * @return $this
     */
    public function setInboundCount($inboundCount)
    {
        $this->container['inboundCount'] = $inboundCount;
    ...
    {
        return $this->get('outboundCount');
    }

    /**
     * Sets outboundCount
     *
     * @param int|null $outboundCount Number of outbound payments sent during the cycle
     *
     * @return $this
     */
    public function setOutboundCount($outboundCount)
    {
        $this->container['outboundCount'] = $outboundCount;
