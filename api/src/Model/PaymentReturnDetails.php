...
/**
 * PaymentReturnDetails Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaymentReturnDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentReturnDetails';
    ...
    protected static $attributeMap = [
        'paymentBeingReturned' => 'paymentBeingReturned',
        'code' => 'code',
    ...
    protected static $setters = [
        'paymentBeingReturned' => 'setPaymentBeingReturned',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'paymentBeingReturned' => 'getPaymentBeingReturned',
        'code' => 'getCode',
    ...
    {
        $this->container['paymentBeingReturned'] = $data['paymentBeingReturned'] ?? null;
    ...
    /**
     * Gets paymentBeingReturned
     *
     * @return string|null
     */
    public function getPaymentBeingReturned()
    {
        return $this->get('paymentBeingReturned');
    }

    /**
     * Sets paymentBeingReturned
     *
     * @param string|null $paymentBeingReturned UUID of the payment being returned if known
     *
     * @return $this
     */
    public function setPaymentBeingReturned($paymentBeingReturned)
    {
        $this->container['paymentBeingReturned'] = $paymentBeingReturned;
     ...
     * Sets code
     *
     * @param string|null $code Unique identifier of the reason for return
     *
     * @return $this
     */
    public function setCode($code)
    {
        if (! is_null($code) && (mb_strlen($code) > 8)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PaymentReturnDetails., must be smaller than or equal to 8.');
        }
        if (! is_null($code) && (mb_strlen($code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PaymentReturnDetails., must be bigger than or equal to 0.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Human-readable description of the return reason
     *
     * @return $this
     */
    public function setDescription($description)
    {
        if (! is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PaymentReturnDetails., must be smaller than or equal to 255.');
        }
        if (! is_null($description) && (mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PaymentReturnDetails., must be bigger than or equal to 0.');
        }
