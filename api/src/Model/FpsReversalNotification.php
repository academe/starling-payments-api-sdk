...
/**
 * FpsReversalNotification Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class FpsReversalNotification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FpsReversalNotification';
    ...
    protected static $openAPITypes = [
        ...
        'reversalAmount' => '\Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount',
        'reasonCode' => 'string',
    ...
    protected static $setters = [
        ...
        'reversalAmount' => 'setReversalAmount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reversalAmount'] = $data['reversalAmount'] ?? null;
     ...
     * Sets paymentUid
     *
     * @param string|null $paymentUid Unique identifier of the payment being reversed by the scheme
     *
     * @return $this
     */
     ...
     *
     * @param string|null $paymentAccountUid Unique identifier of the account the funds were applied to
     *
     * @return $this
     */
    ...
    {
        return $this->get('reversalAmount');
    }

    /**
     * Sets reversalAmount
     *
     * @param \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount|null $reversalAmount reversalAmount
     *
     * @return $this
     */
    public function setReversalAmount($reversalAmount)
    {
        $this->container['reversalAmount'] = $reversalAmount;
     ...
     * Sets reasonCode
     *
     * @param string|null $reasonCode FPS scheme reason code for the payment reversal
     *
     * @return $this
     */
    public function setReasonCode($reasonCode)
    {
        if (! is_null($reasonCode) && (mb_strlen($reasonCode) > 8)) {
            throw new \InvalidArgumentException('invalid length for $reasonCode when calling FpsReversalNotification., must be smaller than or equal to 8.');
        }
        if (! is_null($reasonCode) && (mb_strlen($reasonCode) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reasonCode when calling FpsReversalNotification., must be bigger than or equal to 0.');
        }
    ...
    public function setReasonDescription($reasonDescription)
    {
        if (! is_null($reasonDescription) && (mb_strlen($reasonDescription) > 255)) {
            throw new \InvalidArgumentException('invalid length for $reasonDescription when calling FpsReversalNotification., must be smaller than or equal to 255.');
        }
        if (! is_null($reasonDescription) && (mb_strlen($reasonDescription) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reasonDescription when calling FpsReversalNotification., must be bigger than or equal to 0.');
        }
