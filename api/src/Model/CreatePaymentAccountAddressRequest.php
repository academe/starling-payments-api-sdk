...
/**
 * CreatePaymentAccountAddressRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class CreatePaymentAccountAddressRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentAccountAddressRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/", $this->container['accountName'])) {
            $invalidProperties[] = sprintf(
        ...
        if ($this->container['sortCode'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'sortCode');
        }
        if ((mb_strlen($this->container['sortCode']) > 6)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be smaller than or equal to %d.',
                'sortCode',
                6
        ...
        if (! preg_match("/\\d{6}/", $this->container['sortCode'])) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be conform to the pattern "%s".',
                'sortCode',
                "/\\d{6}/"
     ...
     * Sets accountName
     *
     * @param string $accountName Name of the account holder, this will be included in outbound payment instructions
     *
     * @return $this
     */
    public function setAccountName($accountName)
    {
        if ((mb_strlen($accountName) > 40)) {
            throw new \InvalidArgumentException('invalid length for $accountName when calling CreatePaymentAccountAddressRequest., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($accountName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $accountName when calling CreatePaymentAccountAddressRequest., must be bigger than or equal to 1.');
        }
        if ((! preg_match("/[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/", $accountName))) {
            throw new \InvalidArgumentException("invalid value for $accountName when calling CreatePaymentAccountAddressRequest., must conform to the pattern /[a-zA-Z0-9-\/?:().,+#=!%&*<>;{@ \"']{1,40}/.");
        }
     ...
     * Sets sortCode
     *
     * @param string $sortCode UK sort code for sending and receiving payments, must be within the set of sort codes allocated to the payment business
     *
     * @return $this
     */
    public function setSortCode($sortCode)
    {
        if ((mb_strlen($sortCode) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sortCode when calling CreatePaymentAccountAddressRequest., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($sortCode) < 6)) {
            throw new \InvalidArgumentException('invalid length for $sortCode when calling CreatePaymentAccountAddressRequest., must be bigger than or equal to 6.');
        }
        if ((! preg_match("/\\d{6}/", $sortCode))) {
            throw new \InvalidArgumentException("invalid value for $sortCode when calling CreatePaymentAccountAddressRequest., must conform to the pattern /\\d{6}/.");
        }
    ...
    public function setAccountNumber($accountNumber)
    {
        if (! is_null($accountNumber) && (mb_strlen($accountNumber) > 8)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling CreatePaymentAccountAddressRequest., must be smaller than or equal to 8.');
        }
        if (! is_null($accountNumber) && (mb_strlen($accountNumber) < 8)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling CreatePaymentAccountAddressRequest., must be bigger than or equal to 8.');
        }
        if (! is_null($accountNumber) && (! preg_match("/\\d{8}/", $accountNumber))) {
            throw new \InvalidArgumentException("invalid value for $accountNumber when calling CreatePaymentAccountAddressRequest., must conform to the pattern /\\d{8}/.");
        }
