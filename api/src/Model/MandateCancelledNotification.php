...
/**
 * MandateCancelledNotification Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class MandateCancelledNotification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MandateCancelledNotification';
     ...
     *
     * @param string|null $paymentBusinessUid Unique identifier of the company for whom the mandate has been cancelled
     *
     * @return $this
     */
     ...
     *
     * @param string|null $paymentAccountUid Unique identifier of the account for which payments for the mandate were taken
     *
     * @return $this
     */
     ...
     * Sets addressUid
     *
     * @param string|null $addressUid Unique identifier of the address that the mandate was addressed to
     *
     * @return $this
     */
     ...
     * Sets mandateUid
     *
     * @param string|null $mandateUid Unique identifier of the mandate that has been cancelled
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param string|null $reference The originator defined reference for the mandate
     *
     * @return $this
     */
    public function setReference($reference)
    {
        if (! is_null($reference) && (mb_strlen($reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling MandateCancelledNotification., must be smaller than or equal to 18.');
        }
        if (! is_null($reference) && (mb_strlen($reference) < 6)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling MandateCancelledNotification., must be bigger than or equal to 6.');
        }
     ...
     * Sets cancelledAt
     *
     * @param \DateTime|null $cancelledAt Time at which the mandate was cancelled
     *
     * @return $this
     */
