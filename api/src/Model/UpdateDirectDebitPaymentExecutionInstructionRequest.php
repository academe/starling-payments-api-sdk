...
/**
 * UpdateDirectDebitPaymentExecutionInstructionRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class UpdateDirectDebitPaymentExecutionInstructionRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDirectDebitPaymentExecutionInstructionRequest';
    ...
    const PAYMENT_INSTRUCTION_INSUFFICIENT_FUNDS = 'INSUFFICIENT_FUNDS';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['paymentInstruction'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'paymentInstruction');
        }
     ...
     *
     * @param string $paymentInstruction Whether direct debit payment should be paid
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getPaymentInstructionAllowableValues();
        if (!in_array($paymentInstruction, $allowedValues, true)) {
