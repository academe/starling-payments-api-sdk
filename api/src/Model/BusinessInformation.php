...
/**
 * BusinessInformation Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class BusinessInformation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessInformation';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'netSenderCap' => '\Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['netSenderCap'] = $data['netSenderCap'] ?? null;
    }
     ...
     */
    public function getNetSenderCap()
    {
        return $this->get('netSenderCap');
    }

    /**
     * Sets netSenderCap
     *
     * @param \Academe\Starling\PaymentsSdk\Model\CurrencyAndAmount|null $netSenderCap netSenderCap
     *
     * @return $this
     */
    public function setNetSenderCap($netSenderCap)
    {
        $this->container['netSenderCap'] = $netSenderCap;
