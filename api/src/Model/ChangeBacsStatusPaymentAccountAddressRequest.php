...
/**
 * ChangeBacsStatusPaymentAccountAddressRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ChangeBacsStatusPaymentAccountAddressRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangeBacsStatusPaymentAccountAddressRequest';
    ...
    protected static $openAPITypes = [
        'directCreditPaymentsStatus' => 'string',
        'directDebitPaymentsStatus' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'directCreditPaymentsStatus' => null,
        'directDebitPaymentsStatus' => null
    ];
    ...
    protected static $attributeMap = [
        'directCreditPaymentsStatus' => 'directCreditPaymentsStatus',
        'directDebitPaymentsStatus' => 'directDebitPaymentsStatus'
    ];
    ...
    protected static $setters = [
        'directCreditPaymentsStatus' => 'setDirectCreditPaymentsStatus',
        'directDebitPaymentsStatus' => 'setDirectDebitPaymentsStatus'
    ];
    ...
    protected static $getters = [
        'directCreditPaymentsStatus' => 'getDirectCreditPaymentsStatus',
        'directDebitPaymentsStatus' => 'getDirectDebitPaymentsStatus'
    ];
    ...
    const DIRECT_CREDIT_PAYMENTS_STATUS_ENABLED = 'ENABLED';
    const DIRECT_CREDIT_PAYMENTS_STATUS_DISABLED = 'DISABLED';const DIRECT_DEBIT_PAYMENTS_STATUS_ENABLED = 'ENABLED';
    const DIRECT_DEBIT_PAYMENTS_STATUS_DISABLED = 'DISABLED';
     ...
     * @return string[]
     */
    public function getDirectCreditPaymentsStatusAllowableValues()
    {
        return [
            self::DIRECT_CREDIT_PAYMENTS_STATUS_ENABLED,
            self::DIRECT_CREDIT_PAYMENTS_STATUS_DISABLED,
        ];
    }
     ...
     * @return string[]
     */
    public function getDirectDebitPaymentsStatusAllowableValues()
    {
        return [
            self::DIRECT_DEBIT_PAYMENTS_STATUS_ENABLED,
            self::DIRECT_DEBIT_PAYMENTS_STATUS_DISABLED,
        ];
    }
    ...
    {
        $this->container['directCreditPaymentsStatus'] = $data['directCreditPaymentsStatus'] ?? null;
        $this->container['directDebitPaymentsStatus'] = $data['directDebitPaymentsStatus'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['directCreditPaymentsStatus'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'directCreditPaymentsStatus');
        }
        $allowedValues = $this->getDirectCreditPaymentsStatusAllowableValues();
        if (!is_null($this->container['directCreditPaymentsStatus']) && !in_array($this->container['directCreditPaymentsStatus'], $allowedValues, true)) {
        ...
        if ($this->container['directDebitPaymentsStatus'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'directDebitPaymentsStatus');
        }
        $allowedValues = $this->getDirectDebitPaymentsStatusAllowableValues();
        if (!is_null($this->container['directDebitPaymentsStatus']) && !in_array($this->container['directDebitPaymentsStatus'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be one of "%s"',
    ...
    /**
     * Gets directCreditPaymentsStatus
     *
     * @return string
     */
    public function getDirectCreditPaymentsStatus()
    {
        return $this->get('directCreditPaymentsStatus');
    }

    /**
     * Sets directCreditPaymentsStatus
     *
     * @param string $directCreditPaymentsStatus Indicates if the account has been allowed by the account owner to receive direct credit payments, if disabled then all direct credit payments to this account will be rejected
     *
     * @return $this
     */
    public function setDirectCreditPaymentsStatus($directCreditPaymentsStatus)
    {
        $allowedValues = $this->getDirectCreditPaymentsStatusAllowableValues();
        if (!in_array($directCreditPaymentsStatus, $allowedValues, true)) {
        ...
        $this->container['directCreditPaymentsStatus'] = $directCreditPaymentsStatus;

        return $this;
    }

    /**
     * Gets directDebitPaymentsStatus
     *
     * @return string
     */
    public function getDirectDebitPaymentsStatus()
    {
        return $this->get('directDebitPaymentsStatus');
    }

    /**
     * Sets directDebitPaymentsStatus
     *
     * @param string $directDebitPaymentsStatus Indicates if the account has been allowed by the account owner to make direct debit payments, if disabled then all attempts to collect direct debit payments and mandates from this account will be rejected
     *
     * @return $this
     */
    public function setDirectDebitPaymentsStatus($directDebitPaymentsStatus)
    {
        $allowedValues = $this->getDirectDebitPaymentsStatusAllowableValues();
        if (!in_array($directDebitPaymentsStatus, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    'Invalid value for "%s", must be one of "%s"',
                    'directDebitPaymentsStatus',
        ...
        $this->container['directDebitPaymentsStatus'] = $directDebitPaymentsStatus;
