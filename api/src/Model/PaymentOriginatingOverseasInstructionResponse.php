...
/**
 * PaymentOriginatingOverseasInstructionResponse Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaymentOriginatingOverseasInstructionResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentOriginatingOverseasInstructionResponse';
     ...
     * Sets paymentUid
     *
     * @param string|null $paymentUid Unique identifier of the instructed payment
     *
     * @return $this
     */
