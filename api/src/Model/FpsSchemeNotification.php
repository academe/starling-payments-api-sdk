...
/**
 * FpsSchemeNotification Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class FpsSchemeNotification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FpsSchemeNotification';
    ...
    protected static $setters = [
        'notificationUid' => 'setNotificationUid',
        ...
        'settlementCycle' => 'setSettlementCycle',
    ...
    const PAYMENT_STATE_RETRIED_AS_FDP = 'RETRIED_AS_FDP';
    const PAYMENT_STATE_REJECTED = 'REJECTED';const SETTLEMENT_CYCLE__001 = 'CYCLE_001';
    const SETTLEMENT_CYCLE__002 = 'CYCLE_002';
    const SETTLEMENT_CYCLE__003 = 'CYCLE_003';
    const SETTLEMENT_CYCLE_UNKNOWN = 'CYCLE_UNKNOWN';
    ...
    {
        return [
            self::PAYMENT_STATE_ACCEPTED,
            self::PAYMENT_STATE_RETRIED_AS_FDP,
            self::PAYMENT_STATE_REJECTED,
        ];
    }
     ...
     * @return string[]
     */
    public function getSettlementCycleAllowableValues()
    {
        return [
            self::SETTLEMENT_CYCLE__001,
            self::SETTLEMENT_CYCLE__002,
            self::SETTLEMENT_CYCLE__003,
            self::SETTLEMENT_CYCLE_UNKNOWN,
        ];
    }
    ...
    {
        $this->container['notificationUid'] = $data['notificationUid'] ?? null;
        $this->container['paymentUid'] = $data['paymentUid'] ?? null;
        $this->container['paymentState'] = $data['paymentState'] ?? null;
        $this->container['reasonCode'] = $data['reasonCode'] ?? null;
        $this->container['reasonDescription'] = $data['reasonDescription'] ?? null;
        $this->container['fpid'] = $data['fpid'] ?? null;
        $this->container['settlementCycleUid'] = $data['settlementCycleUid'] ?? null;
        $this->container['settlementCycle'] = $data['settlementCycle'] ?? null;
        $this->container['settlementDate'] = $data['settlementDate'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['paymentState']) && !in_array($this->container['paymentState'], $allowedValues, true)) {
        ...
        if (! is_null($this->container['reasonCode']) && (mb_strlen($this->container['reasonCode']) > 8)) {
            $invalidProperties[] = sprintf(
        ...
        if (! is_null($this->container['reasonCode']) && (mb_strlen($this->container['reasonCode']) < 0)) {
            $invalidProperties[] = sprintf(
        ...
        if (! is_null($this->container['reasonDescription']) && (mb_strlen($this->container['reasonDescription']) > 255)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be smaller than or equal to %d.',
                'reasonDescription',
                255
        ...
        if (! is_null($this->container['fpid']) && (mb_strlen($this->container['fpid']) > 42)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be smaller than or equal to %d.',
                'fpid',
                42
        ...
        if (! is_null($this->container['fpid']) && (mb_strlen($this->container['fpid']) < 0)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", the character length must be bigger than or equal to %d.',
                'fpid',
                0
        ...
        $allowedValues = $this->getSettlementCycleAllowableValues();
        if (!is_null($this->container['settlementCycle']) && !in_array($this->container['settlementCycle'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                'invalid value for "%s", must be one of "%s"',
                'settlementCycle',
                implode('", "', $allowedValues)
     ...
     * @return string|null
     */
    public function getNotificationUid()
    {
        return $this->get('notificationUid');
    }

    /**
     * Sets notificationUid
     *
     * @param string|null $notificationUid Unique identifier of the notification
     *
     * @return $this
     */
    public function setNotificationUid($notificationUid)
    {
        $this->container['notificationUid'] = $notificationUid;
     ...
     * Sets paymentUid
     *
     * @param string|null $paymentUid Unique identifier of the payment the notification relates to
     *
     * @return $this
     */
     ...
     * Sets paymentState
     *
     * @param string|null $paymentState Current state of the payment in the FPS scheme
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getPaymentStateAllowableValues();
        if (! is_null($paymentState) && !in_array($paymentState, $allowedValues, true)) {
     ...
     * Sets reasonCode
     *
     * @param string|null $reasonCode FPS scheme reason code for the notification / state change
     *
     * @return $this
     */
    public function setReasonCode($reasonCode)
    {
        if (! is_null($reasonCode) && (mb_strlen($reasonCode) > 8)) {
            throw new \InvalidArgumentException('invalid length for $reasonCode when calling FpsSchemeNotification., must be smaller than or equal to 8.');
        }
        if (! is_null($reasonCode) && (mb_strlen($reasonCode) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reasonCode when calling FpsSchemeNotification., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $reasonDescription Human readable description of the reasonCode
     *
     * @return $this
     */
    public function setReasonDescription($reasonDescription)
    {
        if (! is_null($reasonDescription) && (mb_strlen($reasonDescription) > 255)) {
            throw new \InvalidArgumentException('invalid length for $reasonDescription when calling FpsSchemeNotification., must be smaller than or equal to 255.');
        }
        if (! is_null($reasonDescription) && (mb_strlen($reasonDescription) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reasonDescription when calling FpsSchemeNotification., must be bigger than or equal to 0.');
        }
    ...
    {
        if (! is_null($fpid) && (mb_strlen($fpid) > 42)) {
            throw new \InvalidArgumentException('invalid length for $fpid when calling FpsSchemeNotification., must be smaller than or equal to 42.');
        }
        if (! is_null($fpid) && (mb_strlen($fpid) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fpid when calling FpsSchemeNotification., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $settlementCycleUid Unique identifier of the settlement cycle the payment has been assigned to (where known)
     *
     * @return $this
     */
    ...
    /**
     * Gets settlementCycle
     *
     * @return string|null
     */
    public function getSettlementCycle()
    {
        return $this->get('settlementCycle');
    }

    /**
     * Sets settlementCycle
     *
     * @param string|null $settlementCycle Settlement cycle of the payment (where known)
     *
     * @return $this
     */
    public function setSettlementCycle($settlementCycle)
    {
        $allowedValues = $this->getSettlementCycleAllowableValues();
        if (! is_null($settlementCycle) && !in_array($settlementCycle, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    'Invalid value for "%s", must be one of "%s"',
                    'settlementCycle',
        ...
        $this->container['settlementCycle'] = $settlementCycle;
    ...
    {
        return $this->get('settlementDate');
    }

    /**
     * Sets settlementDate
     *
     * @param \DateTime|null $settlementDate Settlement date of the payment (where known)
     *
     * @return $this
     */
     ...
     * Sets timestamp
     *
     * @param \DateTime|null $timestamp Timestamp of the notification from the scheme
     *
     * @return $this
     */
