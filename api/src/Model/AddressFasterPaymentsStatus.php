...
/**
 * AddressFasterPaymentsStatus Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class AddressFasterPaymentsStatus implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddressFasterPaymentsStatus';
     ...
     * Sets inboundStatus
     *
     * @param string|null $inboundStatus Inbound faster payments status of the address which controls responses to the scheme on receipt of payment instructions for ACTIVE addresses
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getInboundStatusAllowableValues();
        if (! is_null($inboundStatus) && !in_array($inboundStatus, $allowedValues, true)) {
     ...
     * Sets outboundStatus
     *
     * @param string|null $outboundStatus Outbound faster payments status of the address which controls whether outbound payment instructions will be accepted for ACTIVE addresses
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getOutboundStatusAllowableValues();
        if (! is_null($outboundStatus) && !in_array($outboundStatus, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    'Invalid value for "%s", must be one of "%s"',
                    'outboundStatus',
