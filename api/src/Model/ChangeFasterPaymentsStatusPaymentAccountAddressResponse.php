...
/**
 * ChangeFasterPaymentsStatusPaymentAccountAddressResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ChangeFasterPaymentsStatusPaymentAccountAddressResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangeFasterPaymentsStatusPaymentAccountAddressResponse';
     ...
     * Sets success
     *
     * @param bool|null $success True if the request completed successfully
     *
     * @return $this
     */
