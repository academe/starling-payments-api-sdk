...
/**
 * DirectDebitPaymentDueNotification Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DirectDebitPaymentDueNotification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DirectDebitPaymentDueNotification';
     ...
     *
     * @param string|null $paymentBusinessUid Unique identifier of the company making the payment
     *
     * @return $this
     */
     ...
     *
     * @param string|null $paymentAccountUid Unique identifier of the account from which the funds will be taken
     *
     * @return $this
     */
     ...
     * Sets addressUid
     *
     * @param string|null $addressUid Unique identifier of the address the payment will be taken from
     *
     * @return $this
     */
     ...
     * Sets mandateUid
     *
     * @param string|null $mandateUid Unique identifier of the mandate under which the payment will be taken
     *
     * @return $this
     */
    ...
    public function setReference($reference)
    {
        if (! is_null($reference) && (mb_strlen($reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling DirectDebitPaymentDueNotification., must be smaller than or equal to 18.');
        }
        if (! is_null($reference) && (mb_strlen($reference) < 6)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling DirectDebitPaymentDueNotification., must be bigger than or equal to 6.');
        }
     ...
     * Sets paymentDueAt
     *
     * @param \DateTime|null $paymentDueAt Date that the payment will be debited from the account
     *
     * @return $this
     */
