...
/**
 * AccountNumberAndSortCode Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class AccountNumberAndSortCode implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountNumberAndSortCode';
    ...
    public function setAccountNumber($accountNumber)
    {
        if (! is_null($accountNumber) && (mb_strlen($accountNumber) > 8)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling AccountNumberAndSortCode., must be smaller than or equal to 8.');
        }
        if (! is_null($accountNumber) && (mb_strlen($accountNumber) < 8)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling AccountNumberAndSortCode., must be bigger than or equal to 8.');
        }
     ...
     * Sets sortCode
     *
     * @param string|null $sortCode Bank sort code
     *
     * @return $this
     */
    public function setSortCode($sortCode)
    {
        if (! is_null($sortCode) && (mb_strlen($sortCode) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sortCode when calling AccountNumberAndSortCode., must be smaller than or equal to 6.');
        }
        if (! is_null($sortCode) && (mb_strlen($sortCode) < 6)) {
            throw new \InvalidArgumentException('invalid length for $sortCode when calling AccountNumberAndSortCode., must be bigger than or equal to 6.');
        }
