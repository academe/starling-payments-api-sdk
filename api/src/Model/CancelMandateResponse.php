...
/**
 * CancelMandateResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class CancelMandateResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelMandateResponse';
     ...
     * Sets mandateUid
     *
     * @param string|null $mandateUid Unique identifier of mandate
     *
     * @return $this
     */
