...
/**
 * PaymentAccountAddressApi Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaymentAccountAddressApi
{
    /**
     * @var Configuration
     */
    ...
    /**
     * Operation changePaymentAccountAddressFasterPaymentsStatus
     *
     ...
     * @param  \Academe\Starling\PaymentsSdk\Model\ChangeFasterPaymentsStatusPaymentAccountAddressRequest $changeFasterPaymentsStatusPaymentAccountAddressRequest Payload describing the new account address faster payments status (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\ChangeStatusPaymentAccountAddressResponse|\Academe\Starling\PaymentsSdk\Model\ChangeStatusPaymentAccountAddressResponse
     */
    public function changePaymentAccountAddressFasterPaymentsStatus($paymentBusinessUid, $accountUid, $addressUid, $changeFasterPaymentsStatusPaymentAccountAddressRequest)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->changePaymentAccountAddressFasterPaymentsStatusWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $changeFasterPaymentsStatusPaymentAccountAddressRequest);
    ...
    /**
     * Operation changePaymentAccountAddressFasterPaymentsStatusWithHttpInfo
     *
     * Changes the faster payments status of the account, for instance marking the address as incoming or outgoing payments disabled.
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\ChangeStatusPaymentAccountAddressResponse|\Academe\Starling\PaymentsSdk\Model\ChangeStatusPaymentAccountAddressResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function changePaymentAccountAddressFasterPaymentsStatusWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $changeFasterPaymentsStatusPaymentAccountAddressRequest)
    {
        $request = $this->changePaymentAccountAddressFasterPaymentsStatusRequest($paymentBusinessUid, $accountUid, $addressUid, $changeFasterPaymentsStatusPaymentAccountAddressRequest);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\ChangeStatusPaymentAccountAddressResponse'),
                    'request' => $request,
                    'response' => $response
                ];
            case 400:
        ...
        $returnType = '\Academe\Starling\PaymentsSdk\Model\ChangeStatusPaymentAccountAddressResponse';
    ...
    /**
     * Create request for operation 'changePaymentAccountAddressFasterPaymentsStatus'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     ...
     */
    public function changePaymentAccountAddressFasterPaymentsStatusRequest($paymentBusinessUid, $accountUid, $addressUid, $changeFasterPaymentsStatusPaymentAccountAddressRequest)
    {
        ...
        // Verify the required parameter 'changeFasterPaymentsStatusPaymentAccountAddressRequest' is set

        if ($changeFasterPaymentsStatusPaymentAccountAddressRequest === null || (is_array($changeFasterPaymentsStatusPaymentAccountAddressRequest) && count($changeFasterPaymentsStatusPaymentAccountAddressRequest) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address/{addressUid}/faster-payments-status';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($changeFasterPaymentsStatusPaymentAccountAddressRequest)) {
            $_tempBody = $changeFasterPaymentsStatusPaymentAccountAddressRequest;
        }
    ...
    /**
     * Operation changePaymentAccountAddressStatus
     *
     ...
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     * @param  \Academe\Starling\PaymentsSdk\Model\ChangeStatusPaymentAccountAddressRequest $changeStatusPaymentAccountAddressRequest Payload describing the new account address status (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\ChangeStatusPaymentAccountAddressResponse|\Academe\Starling\PaymentsSdk\Model\ChangeStatusPaymentAccountAddressResponse
     */
    public function changePaymentAccountAddressStatus($paymentBusinessUid, $accountUid, $addressUid, $changeStatusPaymentAccountAddressRequest)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->changePaymentAccountAddressStatusWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $changeStatusPaymentAccountAddressRequest);
    ...
    /**
     * Operation changePaymentAccountAddressStatusWithHttpInfo
     *
     * Changes the status of the account on the scheme, for instance marking the address as closed. Once the status has been changed to a terminal status, the address cannot be reactivated
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\ChangeStatusPaymentAccountAddressResponse|\Academe\Starling\PaymentsSdk\Model\ChangeStatusPaymentAccountAddressResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function changePaymentAccountAddressStatusWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $changeStatusPaymentAccountAddressRequest)
    {
        $request = $this->changePaymentAccountAddressStatusRequest($paymentBusinessUid, $accountUid, $addressUid, $changeStatusPaymentAccountAddressRequest);
    ...
    /**
     * Create request for operation 'changePaymentAccountAddressStatus'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     ...
     * @return RequestInterface
     */
    public function changePaymentAccountAddressStatusRequest($paymentBusinessUid, $accountUid, $addressUid, $changeStatusPaymentAccountAddressRequest)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        // Verify the required parameter 'changeStatusPaymentAccountAddressRequest' is set

        if ($changeStatusPaymentAccountAddressRequest === null || (is_array($changeStatusPaymentAccountAddressRequest) && count($changeStatusPaymentAccountAddressRequest) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address/{addressUid}/status';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($changeStatusPaymentAccountAddressRequest)) {
            $_tempBody = $changeStatusPaymentAccountAddressRequest;
        }
    ...
    /**
     * Operation createAccountAddress
     *
     ...
     * @param  string $addressUid The identifier of the individual account address (required)
     * @param  \Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountAddressRequest $createPaymentAccountAddressRequest Payload describing the account address to be created (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountAddressResponse|\Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountAddressResponse
     */
    public function createAccountAddress($paymentBusinessUid, $accountUid, $addressUid, $createPaymentAccountAddressRequest)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->createAccountAddressWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $createPaymentAccountAddressRequest);
    ...
    /**
     * Operation createAccountAddressWithHttpInfo
     *
     * Creates an address for the account on the UK faster payments network by assigning an account number and sort code. The operation can also be used to change the name on an existing address.
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @throws RequestExceptionInterface if the request is malformed
     * @throws NetworkExceptionInterface if the network is down
     * @return array of \Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountAddressResponse|\Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountAddressResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAccountAddressWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $createPaymentAccountAddressRequest)
    {
        $request = $this->createAccountAddressRequest($paymentBusinessUid, $accountUid, $addressUid, $createPaymentAccountAddressRequest);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountAddressResponse'),
                    'request' => $request,
                    'response' => $response
                ];
            case 400:
        ...
        $returnType = '\Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountAddressResponse';
    ...
    /**
     * Create request for operation 'createAccountAddress'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payments account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     ...
     * @return RequestInterface
     */
    public function createAccountAddressRequest($paymentBusinessUid, $accountUid, $addressUid, $createPaymentAccountAddressRequest)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        // Verify the required parameter 'createPaymentAccountAddressRequest' is set

        if ($createPaymentAccountAddressRequest === null || (is_array($createPaymentAccountAddressRequest) && count($createPaymentAccountAddressRequest) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address/{addressUid}';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($createPaymentAccountAddressRequest)) {
            $_tempBody = $createPaymentAccountAddressRequest;
        }
    ...
    /**
     * Operation getPaymentAccountAddress
     *
     ...
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\PaymentAccountAddress
     */
    public function getPaymentAccountAddress($paymentBusinessUid, $accountUid, $addressUid)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->getPaymentAccountAddressWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid);
    ...
    /**
     * Operation getPaymentAccountAddressWithHttpInfo
     *
     * Gets the details of a payment account address
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @throws RequestExceptionInterface if the request is malformed
     * @throws NetworkExceptionInterface if the network is down
     * @return array of \Academe\Starling\PaymentsSdk\Model\PaymentAccountAddress, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentAccountAddressWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid)
    {
        $request = $this->getPaymentAccountAddressRequest($paymentBusinessUid, $accountUid, $addressUid);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\PaymentAccountAddress'),
                    'request' => $request,
                    'response' => $response
                ];
        }

        $returnType = '\Academe\Starling\PaymentsSdk\Model\PaymentAccountAddress';
    ...
    /**
     * Create request for operation 'getPaymentAccountAddress'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     ...
     * @return RequestInterface
     */
    public function getPaymentAccountAddressRequest($paymentBusinessUid, $accountUid, $addressUid)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
...
// Path parameters
    ...
    /**
     * Operation getPaymentAccountAddresses
     *
     * List of addresses for a payment account
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payments account (required)
     * @param  int $page Page number (pages of 100 addresses) (optional)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\PaymentAccountAddress[]
     */
    public function getPaymentAccountAddresses($paymentBusinessUid, $accountUid, $page = null)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->getPaymentAccountAddressesWithHttpInfo($paymentBusinessUid, $accountUid, $page);
    ...
    /**
     * Operation getPaymentAccountAddressesWithHttpInfo
     *
     * List of addresses for a payment account
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\PaymentAccountAddress[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentAccountAddressesWithHttpInfo($paymentBusinessUid, $accountUid, $page = null)
    {
        $request = $this->getPaymentAccountAddressesRequest($paymentBusinessUid, $accountUid, $page);
    ...
    /**
     * Create request for operation 'getPaymentAccountAddresses'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payments account (required)
     * @param  int $page Page number (pages of 100 addresses) (optional)
     ...
     * @return RequestInterface
     */
    public function getPaymentAccountAddressesRequest($paymentBusinessUid, $accountUid, $page = null)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
    ...
    /**
     * Operation updateBacsPaymentStatus
     *
     ...
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     * @param  \Academe\Starling\PaymentsSdk\Model\ChangeBacsStatusPaymentAccountAddressRequest $changeBacsStatusPaymentAccountAddressRequest Payload describing the new account address bacs status (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\ChangeBacsStatusPaymentAccountAddressResponse|\Academe\Starling\PaymentsSdk\Model\ChangeBacsStatusPaymentAccountAddressResponse
     */
    public function updateBacsPaymentStatus($paymentBusinessUid, $accountUid, $addressUid, $changeBacsStatusPaymentAccountAddressRequest)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->updateBacsPaymentStatusWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $changeBacsStatusPaymentAccountAddressRequest);
    ...
    /**
     * Operation updateBacsPaymentStatusWithHttpInfo
     *
     * Sets the account level configuration for accepting BACS payments to and from this address
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @throws RequestExceptionInterface if the request is malformed
     * @throws NetworkExceptionInterface if the network is down
     * @return array of \Academe\Starling\PaymentsSdk\Model\ChangeBacsStatusPaymentAccountAddressResponse|\Academe\Starling\PaymentsSdk\Model\ChangeBacsStatusPaymentAccountAddressResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateBacsPaymentStatusWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $changeBacsStatusPaymentAccountAddressRequest)
    {
        $request = $this->updateBacsPaymentStatusRequest($paymentBusinessUid, $accountUid, $addressUid, $changeBacsStatusPaymentAccountAddressRequest);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\ChangeBacsStatusPaymentAccountAddressResponse'),
                    'request' => $request,
                    'response' => $response
                ];
            case 400:
        ...
        $returnType = '\Academe\Starling\PaymentsSdk\Model\ChangeBacsStatusPaymentAccountAddressResponse';
    ...
    /**
     * Create request for operation 'updateBacsPaymentStatus'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     ...
     * @return RequestInterface
     */
    public function updateBacsPaymentStatusRequest($paymentBusinessUid, $accountUid, $addressUid, $changeBacsStatusPaymentAccountAddressRequest)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        // Verify the required parameter 'changeBacsStatusPaymentAccountAddressRequest' is set

        if ($changeBacsStatusPaymentAccountAddressRequest === null || (is_array($changeBacsStatusPaymentAccountAddressRequest) && count($changeBacsStatusPaymentAccountAddressRequest) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address/{addressUid}/bacs-payments-status';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($changeBacsStatusPaymentAccountAddressRequest)) {
            $_tempBody = $changeBacsStatusPaymentAccountAddressRequest;
        }
