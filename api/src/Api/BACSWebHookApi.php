...
/**
 * BACSWebHookApi Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
...
class BACSWebHookApi
{
    ...
    /**
     * Operation directCreditReceived
     *
     * Notification that a direct credit payment has been received.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectCreditPaymentReceivedNotification $directCreditPaymentReceivedNotification Notification that a direct credit has been received for an account address (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function directCreditReceived($directCreditPaymentReceivedNotification)
    {
        $this->directCreditReceivedWithHttpInfo($directCreditPaymentReceivedNotification);
    }

    /**
     * Operation directCreditReceivedWithHttpInfo
     *
     * Notification that a direct credit payment has been received.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectCreditPaymentReceivedNotification $directCreditPaymentReceivedNotification Notification that a direct credit has been received for an account address (required)
     ...
     */
    public function directCreditReceivedWithHttpInfo($directCreditPaymentReceivedNotification)
    {
        $request = $this->directCreditReceivedRequest($directCreditPaymentReceivedNotification);
    ...
    /**
     * Create request for operation 'directCreditReceived'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectCreditPaymentReceivedNotification $directCreditPaymentReceivedNotification Notification that a direct credit has been received for an account address (required)
     *
     * @throws InvalidArgumentException
     ...
     */
    public function directCreditReceivedRequest($directCreditPaymentReceivedNotification)
    {
        // Verify the required parameter 'directCreditPaymentReceivedNotification' is set

        if ($directCreditPaymentReceivedNotification === null || (is_array($directCreditPaymentReceivedNotification) && count($directCreditPaymentReceivedNotification) === 0)) {
        ...
        $resourcePath = '/your-registered-web-hook-address/direct-credit-received';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($directCreditPaymentReceivedNotification)) {
            $_tempBody = $directCreditPaymentReceivedNotification;
        }
    ...
    /**
     * Operation directDebitCancelled
     *
     * Notification received from Starling rejected a direct debit payment request due to lack of funds.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectDebitPaymentRejectedNotification $directDebitPaymentRejectedNotification Notification that a direct debit payment has been rejected (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function directDebitCancelled($directDebitPaymentRejectedNotification)
    {
        $this->directDebitCancelledWithHttpInfo($directDebitPaymentRejectedNotification);
    }

    /**
     * Operation directDebitCancelledWithHttpInfo
     *
     * Notification received from Starling rejected a direct debit payment request due to lack of funds.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectDebitPaymentRejectedNotification $directDebitPaymentRejectedNotification Notification that a direct debit payment has been rejected (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function directDebitCancelledWithHttpInfo($directDebitPaymentRejectedNotification)
    {
        $request = $this->directDebitCancelledRequest($directDebitPaymentRejectedNotification);
    ...
    /**
     * Create request for operation 'directDebitCancelled'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectDebitPaymentRejectedNotification $directDebitPaymentRejectedNotification Notification that a direct debit payment has been rejected (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function directDebitCancelledRequest($directDebitPaymentRejectedNotification)
    {
        // Verify the required parameter 'directDebitPaymentRejectedNotification' is set

        if ($directDebitPaymentRejectedNotification === null || (is_array($directDebitPaymentRejectedNotification) && count($directDebitPaymentRejectedNotification) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/your-registered-web-hook-address/direct-debit-rejected';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($directDebitPaymentRejectedNotification)) {
            $_tempBody = $directDebitPaymentRejectedNotification;
        }
    ...
    /**
     * Operation directDebitDue
     *
     * Notification that a direct debit payment is due to be paid on the next working day.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectDebitPaymentDueNotification $directDebitPaymentDueNotification Notification of a direct debit payment that is due to be made on the next working day (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function directDebitDue($directDebitPaymentDueNotification)
    {
        $this->directDebitDueWithHttpInfo($directDebitPaymentDueNotification);
    }

    /**
     * Operation directDebitDueWithHttpInfo
     *
     * Notification that a direct debit payment is due to be paid on the next working day.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectDebitPaymentDueNotification $directDebitPaymentDueNotification Notification of a direct debit payment that is due to be made on the next working day (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function directDebitDueWithHttpInfo($directDebitPaymentDueNotification)
    {
        $request = $this->directDebitDueRequest($directDebitPaymentDueNotification);
    ...
    /**
     * Create request for operation 'directDebitDue'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectDebitPaymentDueNotification $directDebitPaymentDueNotification Notification of a direct debit payment that is due to be made on the next working day (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function directDebitDueRequest($directDebitPaymentDueNotification)
    {
        // Verify the required parameter 'directDebitPaymentDueNotification' is set

        if ($directDebitPaymentDueNotification === null || (is_array($directDebitPaymentDueNotification) && count($directDebitPaymentDueNotification) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/your-registered-web-hook-address/direct-debit-due';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($directDebitPaymentDueNotification)) {
            $_tempBody = $directDebitPaymentDueNotification;
        }
    ...
    /**
     * Operation directDebitPaid
     *
     * Notification that a direct debit payment has been paid.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectDebitPaymentPaidNotification $directDebitPaymentPaidNotification Notification of a direct debit payment that has been made (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function directDebitPaid($directDebitPaymentPaidNotification)
    {
        $this->directDebitPaidWithHttpInfo($directDebitPaymentPaidNotification);
    }

    /**
     * Operation directDebitPaidWithHttpInfo
     *
     * Notification that a direct debit payment has been paid.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectDebitPaymentPaidNotification $directDebitPaymentPaidNotification Notification of a direct debit payment that has been made (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function directDebitPaidWithHttpInfo($directDebitPaymentPaidNotification)
    {
        $request = $this->directDebitPaidRequest($directDebitPaymentPaidNotification);
    ...
    /**
     * Create request for operation 'directDebitPaid'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\DirectDebitPaymentPaidNotification $directDebitPaymentPaidNotification Notification of a direct debit payment that has been made (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function directDebitPaidRequest($directDebitPaymentPaidNotification)
    {
        // Verify the required parameter 'directDebitPaymentPaidNotification' is set

        if ($directDebitPaymentPaidNotification === null || (is_array($directDebitPaymentPaidNotification) && count($directDebitPaymentPaidNotification) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/your-registered-web-hook-address/direct-debit-paid';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($directDebitPaymentPaidNotification)) {
            $_tempBody = $directDebitPaymentPaidNotification;
        }
    ...
    /**
     * Operation mandateCancelled
     *
     * Notification received that a direct debit mandate has been cancelled.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\MandateCancelledNotification $mandateCancelledNotification Notification that a direct debit mandate has been cancelled (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function mandateCancelled($mandateCancelledNotification)
    {
        $this->mandateCancelledWithHttpInfo($mandateCancelledNotification);
    }

    /**
     * Operation mandateCancelledWithHttpInfo
     *
     * Notification received that a direct debit mandate has been cancelled.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\MandateCancelledNotification $mandateCancelledNotification Notification that a direct debit mandate has been cancelled (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function mandateCancelledWithHttpInfo($mandateCancelledNotification)
    {
        $request = $this->mandateCancelledRequest($mandateCancelledNotification);
    ...
    /**
     * Create request for operation 'mandateCancelled'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\MandateCancelledNotification $mandateCancelledNotification Notification that a direct debit mandate has been cancelled (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function mandateCancelledRequest($mandateCancelledNotification)
    {
        // Verify the required parameter 'mandateCancelledNotification' is set

        if ($mandateCancelledNotification === null || (is_array($mandateCancelledNotification) && count($mandateCancelledNotification) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/your-registered-web-hook-address/bacs-mandate-cancelled';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($mandateCancelledNotification)) {
            $_tempBody = $mandateCancelledNotification;
        }
    ...
    /**
     * Operation mandateCreated
     *
     * Notification that a direct debit mandate has been created.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\MandateCreatedNotification $mandateCreatedNotification Details of a direct debit mandate which has been received for an address (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function mandateCreated($mandateCreatedNotification)
    {
        $this->mandateCreatedWithHttpInfo($mandateCreatedNotification);
    }

    /**
     * Operation mandateCreatedWithHttpInfo
     *
     * Notification that a direct debit mandate has been created.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\MandateCreatedNotification $mandateCreatedNotification Details of a direct debit mandate which has been received for an address (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function mandateCreatedWithHttpInfo($mandateCreatedNotification)
    {
        $request = $this->mandateCreatedRequest($mandateCreatedNotification);
    ...
    /**
     * Create request for operation 'mandateCreated'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\MandateCreatedNotification $mandateCreatedNotification Details of a direct debit mandate which has been received for an address (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function mandateCreatedRequest($mandateCreatedNotification)
    {
        // Verify the required parameter 'mandateCreatedNotification' is set

        if ($mandateCreatedNotification === null || (is_array($mandateCreatedNotification) && count($mandateCreatedNotification) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/your-registered-web-hook-address/bacs-mandate-created';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($mandateCreatedNotification)) {
            $_tempBody = $mandateCreatedNotification;
        }
