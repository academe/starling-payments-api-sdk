...
/**
 * BACSPaymentsApi Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
...
class BACSPaymentsApi
{
    ...
    /**
     * Operation updateDirectDebitPaymentExecutionInstruction
     *
     ...
     * @param  string $bacsPaymentUid The identifier of the individual direct debit payment (required)
     * @param  \Academe\Starling\PaymentsSdk\Model\UpdateDirectDebitPaymentExecutionInstructionRequest $updateDirectDebitPaymentExecutionInstructionRequest Payload describing the new instruction of a direct debit payment&#39;s execution (optional)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\UpdateDirectDebitPaymentExecutionInstructionResponse|\Academe\Starling\PaymentsSdk\Model\UpdateDirectDebitPaymentExecutionInstructionResponse
     */
    public function updateDirectDebitPaymentExecutionInstruction($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $bacsPaymentUid, $updateDirectDebitPaymentExecutionInstructionRequest = null)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->updateDirectDebitPaymentExecutionInstructionWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $bacsPaymentUid, $updateDirectDebitPaymentExecutionInstructionRequest);
    ...
    /**
     * Operation updateDirectDebitPaymentExecutionInstructionWithHttpInfo
     *
     * Update the status of whether to pay an upcoming direct debit payment
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\UpdateDirectDebitPaymentExecutionInstructionResponse|\Academe\Starling\PaymentsSdk\Model\UpdateDirectDebitPaymentExecutionInstructionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateDirectDebitPaymentExecutionInstructionWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $bacsPaymentUid, $updateDirectDebitPaymentExecutionInstructionRequest = null)
    {
        $request = $this->updateDirectDebitPaymentExecutionInstructionRequest($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $bacsPaymentUid, $updateDirectDebitPaymentExecutionInstructionRequest);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\UpdateDirectDebitPaymentExecutionInstructionResponse'),
                    'request' => $request,
                    'response' => $response
                ];
            case 400:
        ...
        $returnType = '\Academe\Starling\PaymentsSdk\Model\UpdateDirectDebitPaymentExecutionInstructionResponse';
    ...
    /**
     * Create request for operation 'updateDirectDebitPaymentExecutionInstruction'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     ...
     */
    public function updateDirectDebitPaymentExecutionInstructionRequest($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $bacsPaymentUid, $updateDirectDebitPaymentExecutionInstructionRequest = null)
    {
        ...
        // Verify the required parameter 'bacsPaymentUid' is set

        if ($bacsPaymentUid === null || (is_array($bacsPaymentUid) && count($bacsPaymentUid) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
                'bacsPaymentUid',
                'updateDirectDebitPaymentExecutionInstruction'
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address/{addressUid}/mandate/{mandateUid}/payment/{bacsPaymentUid}';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
        ...
        if ($bacsPaymentUid !== null) {
            $resourcePath = str_replace(
                '{' . 'bacsPaymentUid' . '}',
                ObjectSerializer::toPathValue($bacsPaymentUid),
                $resourcePath
            );
        }
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($updateDirectDebitPaymentExecutionInstructionRequest)) {
            $_tempBody = $updateDirectDebitPaymentExecutionInstructionRequest;
        }
