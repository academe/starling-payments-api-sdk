...
/**
 * SettlementCycleApi Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
...
class SettlementCycleApi
{
    ...
    /**
     * Operation getActiveSettlementCycle
     *
     ...
     * @return \Academe\Starling\PaymentsSdk\Model\SettlementCycle
     */
    public function getActiveSettlementCycle($paymentBusinessUid)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->getActiveSettlementCycleWithHttpInfo($paymentBusinessUid);
    ...
    /**
     * Operation getActiveSettlementCycleWithHttpInfo
     *
     * Gets a summary of the current active settlement cycle
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\SettlementCycle, HTTP status code, HTTP response headers (array of strings)
     */
    public function getActiveSettlementCycleWithHttpInfo($paymentBusinessUid)
    {
        $request = $this->getActiveSettlementCycleRequest($paymentBusinessUid);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\SettlementCycle'),
                    'request' => $request,
                    'response' => $response
                ];
        }

        $returnType = '\Academe\Starling\PaymentsSdk\Model\SettlementCycle';
    ...
    /**
     * Create request for operation 'getActiveSettlementCycle'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     *
     * @throws InvalidArgumentException
     ...
     */
    public function getActiveSettlementCycleRequest($paymentBusinessUid)
    {
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/settlement/current';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
    ...
    /**
     * Operation getLastSettlementCycle
     *
     ...
     * @return \Academe\Starling\PaymentsSdk\Model\SettlementCycle
     */
    public function getLastSettlementCycle($paymentBusinessUid)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->getLastSettlementCycleWithHttpInfo($paymentBusinessUid);
    ...
    /**
     * Operation getLastSettlementCycleWithHttpInfo
     *
     * Gets a summary of the last completed settlement cycle
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\SettlementCycle, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLastSettlementCycleWithHttpInfo($paymentBusinessUid)
    {
        $request = $this->getLastSettlementCycleRequest($paymentBusinessUid);
    ...
    /**
     * Create request for operation 'getLastSettlementCycle'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function getLastSettlementCycleRequest($paymentBusinessUid)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/settlement/last';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
    ...
    /**
     * Operation getSettlementCycle
     *
     * Gets the details of a settlement cycle by unique identifier
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $settlementCycleUid The identifier the settlement cycle (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\SettlementCycle
     */
    public function getSettlementCycle($paymentBusinessUid, $settlementCycleUid)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->getSettlementCycleWithHttpInfo($paymentBusinessUid, $settlementCycleUid);
    ...
    /**
     * Operation getSettlementCycleWithHttpInfo
     *
     * Gets the details of a settlement cycle by unique identifier
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\SettlementCycle, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSettlementCycleWithHttpInfo($paymentBusinessUid, $settlementCycleUid)
    {
        $request = $this->getSettlementCycleRequest($paymentBusinessUid, $settlementCycleUid);
    ...
    /**
     * Create request for operation 'getSettlementCycle'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $settlementCycleUid The identifier the settlement cycle (required)
     *
     ...
     * @return RequestInterface
     */
    public function getSettlementCycleRequest($paymentBusinessUid, $settlementCycleUid)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        // Verify the required parameter 'settlementCycleUid' is set

        if ($settlementCycleUid === null || (is_array($settlementCycleUid) && count($settlementCycleUid) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
                'settlementCycleUid',
                'getSettlementCycle'
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/settlement/cycle/{settlementCycleUid}';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
        ...
        if ($settlementCycleUid !== null) {
            $resourcePath = str_replace(
                '{' . 'settlementCycleUid' . '}',
                ObjectSerializer::toPathValue($settlementCycleUid),
                $resourcePath
            );
        }
    ...
    /**
     * Operation getSettlementCyclePayments
     *
     * Gets information about all the payments made within a settlement cycle
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $settlementCycleUid The identifier the settlement cycle (required)
     * @param  int $page Page number (pages of 100 payments) to return for the specified cycle (optional, default to 1)
     * @param  string $ordering The ordering to be used (optional, default to 'CREATED_AT_DESCENDING')
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\PaymentDetails[]
     */
    public function getSettlementCyclePayments($paymentBusinessUid, $settlementCycleUid, $page = 1, $ordering = 'CREATED_AT_DESCENDING')
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->getSettlementCyclePaymentsWithHttpInfo($paymentBusinessUid, $settlementCycleUid, $page, $ordering);
    ...
    /**
     * Operation getSettlementCyclePaymentsWithHttpInfo
     *
     * Gets information about all the payments made within a settlement cycle
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     */
    public function getSettlementCyclePaymentsWithHttpInfo($paymentBusinessUid, $settlementCycleUid, $page = 1, $ordering = 'CREATED_AT_DESCENDING')
    {
        $request = $this->getSettlementCyclePaymentsRequest($paymentBusinessUid, $settlementCycleUid, $page, $ordering);
    ...
    /**
     * Create request for operation 'getSettlementCyclePayments'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $settlementCycleUid The identifier the settlement cycle (required)
     * @param  int $page Page number (pages of 100 payments) to return for the specified cycle (optional, default to 1)
     ...
     * @return RequestInterface
     */
    public function getSettlementCyclePaymentsRequest($paymentBusinessUid, $settlementCycleUid, $page = 1, $ordering = 'CREATED_AT_DESCENDING')
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/settlement/payments/{settlementCycleUid}';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
