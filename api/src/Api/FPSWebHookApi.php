...
/**
 * FPSWebHookApi Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
...
class FPSWebHookApi
{
    ...
    /**
     * Operation inboundPayment
     *
     * Notification of a new inbound payment received to an address for an account managed by the payment business.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsInboundNotification $fpsInboundNotification New inbound payment received for an address (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function inboundPayment($fpsInboundNotification)
    {
        $this->inboundPaymentWithHttpInfo($fpsInboundNotification);
    }

    /**
     * Operation inboundPaymentWithHttpInfo
     *
     * Notification of a new inbound payment received to an address for an account managed by the payment business.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsInboundNotification $fpsInboundNotification New inbound payment received for an address (required)
     ...
     */
    public function inboundPaymentWithHttpInfo($fpsInboundNotification)
    {
        $request = $this->inboundPaymentRequest($fpsInboundNotification);
    ...
    /**
     * Create request for operation 'inboundPayment'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsInboundNotification $fpsInboundNotification New inbound payment received for an address (required)
     *
     * @throws InvalidArgumentException
     ...
     */
    public function inboundPaymentRequest($fpsInboundNotification)
    {
        // Verify the required parameter 'fpsInboundNotification' is set

        if ($fpsInboundNotification === null || (is_array($fpsInboundNotification) && count($fpsInboundNotification) === 0)) {
        ...
        $resourcePath = '/your-registered-web-hook-address/fps-inbound';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($fpsInboundNotification)) {
            $_tempBody = $fpsInboundNotification;
        }
    ...
    /**
     * Operation inboundReturnOfPaymentOriginatingOverseas
     *
     * Notification of a new inbound return of a payment originating overseas for an account managed by the payment business.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasInboundReturnNotification $paymentOriginatingOverseasInboundReturnNotification New inbound return of a payment originating overseas (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function inboundReturnOfPaymentOriginatingOverseas($paymentOriginatingOverseasInboundReturnNotification)
    {
        $this->inboundReturnOfPaymentOriginatingOverseasWithHttpInfo($paymentOriginatingOverseasInboundReturnNotification);
    }

    /**
     * Operation inboundReturnOfPaymentOriginatingOverseasWithHttpInfo
     *
     * Notification of a new inbound return of a payment originating overseas for an account managed by the payment business.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasInboundReturnNotification $paymentOriginatingOverseasInboundReturnNotification New inbound return of a payment originating overseas (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function inboundReturnOfPaymentOriginatingOverseasWithHttpInfo($paymentOriginatingOverseasInboundReturnNotification)
    {
        $request = $this->inboundReturnOfPaymentOriginatingOverseasRequest($paymentOriginatingOverseasInboundReturnNotification);
    ...
    /**
     * Create request for operation 'inboundReturnOfPaymentOriginatingOverseas'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasInboundReturnNotification $paymentOriginatingOverseasInboundReturnNotification New inbound return of a payment originating overseas (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function inboundReturnOfPaymentOriginatingOverseasRequest($paymentOriginatingOverseasInboundReturnNotification)
    {
        // Verify the required parameter 'paymentOriginatingOverseasInboundReturnNotification' is set

        if ($paymentOriginatingOverseasInboundReturnNotification === null || (is_array($paymentOriginatingOverseasInboundReturnNotification) && count($paymentOriginatingOverseasInboundReturnNotification) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/your-registered-web-hook-address/overseas-payment-return';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($paymentOriginatingOverseasInboundReturnNotification)) {
            $_tempBody = $paymentOriginatingOverseasInboundReturnNotification;
        }
    ...
    /**
     * Operation paymentOriginatingOverseasSanctionFailed
     *
     * Notification that a payment originating overseas has been rejected due to it failing sanction checks.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasSanctionFailedNotification $paymentOriginatingOverseasSanctionFailedNotification Notification that a payment originating overseas has failed sanction checks (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function paymentOriginatingOverseasSanctionFailed($paymentOriginatingOverseasSanctionFailedNotification)
    {
        $this->paymentOriginatingOverseasSanctionFailedWithHttpInfo($paymentOriginatingOverseasSanctionFailedNotification);
    }

    /**
     * Operation paymentOriginatingOverseasSanctionFailedWithHttpInfo
     *
     * Notification that a payment originating overseas has been rejected due to it failing sanction checks.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasSanctionFailedNotification $paymentOriginatingOverseasSanctionFailedNotification Notification that a payment originating overseas has failed sanction checks (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentOriginatingOverseasSanctionFailedWithHttpInfo($paymentOriginatingOverseasSanctionFailedNotification)
    {
        $request = $this->paymentOriginatingOverseasSanctionFailedRequest($paymentOriginatingOverseasSanctionFailedNotification);
    ...
    /**
     * Create request for operation 'paymentOriginatingOverseasSanctionFailed'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasSanctionFailedNotification $paymentOriginatingOverseasSanctionFailedNotification Notification that a payment originating overseas has failed sanction checks (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function paymentOriginatingOverseasSanctionFailedRequest($paymentOriginatingOverseasSanctionFailedNotification)
    {
        // Verify the required parameter 'paymentOriginatingOverseasSanctionFailedNotification' is set

        if ($paymentOriginatingOverseasSanctionFailedNotification === null || (is_array($paymentOriginatingOverseasSanctionFailedNotification) && count($paymentOriginatingOverseasSanctionFailedNotification) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/your-registered-web-hook-address/overseas-payment-sanction-failed';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($paymentOriginatingOverseasSanctionFailedNotification)) {
            $_tempBody = $paymentOriginatingOverseasSanctionFailedNotification;
        }
     ...
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsSchemeNotification $fpsSchemeNotification Notification received from the FPS scheme (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function schemeNotification($fpsSchemeNotification)
    {
        $this->schemeNotificationWithHttpInfo($fpsSchemeNotification);
    }

    /**
     * Operation schemeNotificationWithHttpInfo
     *
     * Notification received from the faster payments scheme, typically this is a change in the status of the payment such as an acknowledgement or rejection.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsSchemeNotification $fpsSchemeNotification Notification received from the FPS scheme (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function schemeNotificationWithHttpInfo($fpsSchemeNotification)
    {
        $request = $this->schemeNotificationRequest($fpsSchemeNotification);
    ...
    /**
     * Create request for operation 'schemeNotification'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsSchemeNotification $fpsSchemeNotification Notification received from the FPS scheme (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function schemeNotificationRequest($fpsSchemeNotification)
    {
        // Verify the required parameter 'fpsSchemeNotification' is set

        if ($fpsSchemeNotification === null || (is_array($fpsSchemeNotification) && count($fpsSchemeNotification) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/your-registered-web-hook-address/fps-scheme';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($fpsSchemeNotification)) {
            $_tempBody = $fpsSchemeNotification;
        }
    ...
    /**
     * Operation schemeRedirection
     *
     * Notification of the redirection of an outbound payment instruction.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsRedirectionNotification $fpsRedirectionNotification Redirection information from the scheme (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function schemeRedirection($fpsRedirectionNotification)
    {
        $this->schemeRedirectionWithHttpInfo($fpsRedirectionNotification);
    }

    /**
     * Operation schemeRedirectionWithHttpInfo
     *
     * Notification of the redirection of an outbound payment instruction.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsRedirectionNotification $fpsRedirectionNotification Redirection information from the scheme (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function schemeRedirectionWithHttpInfo($fpsRedirectionNotification)
    {
        $request = $this->schemeRedirectionRequest($fpsRedirectionNotification);
    ...
    /**
     * Create request for operation 'schemeRedirection'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsRedirectionNotification $fpsRedirectionNotification Redirection information from the scheme (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function schemeRedirectionRequest($fpsRedirectionNotification)
    {
        // Verify the required parameter 'fpsRedirectionNotification' is set

        if ($fpsRedirectionNotification === null || (is_array($fpsRedirectionNotification) && count($fpsRedirectionNotification) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/your-registered-web-hook-address/fps-redirection';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($fpsRedirectionNotification)) {
            $_tempBody = $fpsRedirectionNotification;
        }
    ...
    /**
     * Operation schemeReversal
     *
     * Notification of a reversal by the scheme of a previously received inbound payment.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsReversalNotification $fpsReversalNotification Reversal information from the scheme (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function schemeReversal($fpsReversalNotification)
    {
        $this->schemeReversalWithHttpInfo($fpsReversalNotification);
    }

    /**
     * Operation schemeReversalWithHttpInfo
     *
     * Notification of a reversal by the scheme of a previously received inbound payment.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsReversalNotification $fpsReversalNotification Reversal information from the scheme (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function schemeReversalWithHttpInfo($fpsReversalNotification)
    {
        $request = $this->schemeReversalRequest($fpsReversalNotification);
    ...
    /**
     * Create request for operation 'schemeReversal'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\FpsReversalNotification $fpsReversalNotification Reversal information from the scheme (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function schemeReversalRequest($fpsReversalNotification)
    {
        // Verify the required parameter 'fpsReversalNotification' is set

        if ($fpsReversalNotification === null || (is_array($fpsReversalNotification) && count($fpsReversalNotification) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/your-registered-web-hook-address/fps-reversal';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($fpsReversalNotification)) {
            $_tempBody = $fpsReversalNotification;
        }
