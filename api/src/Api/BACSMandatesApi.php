...
/**
 * BACSMandatesApi Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
...
class BACSMandatesApi
{
     ...
     * @param  string $mandateUid The identifier of the individual mandate (required)
     * @param  \Academe\Starling\PaymentsSdk\Model\CancelMandateRequest $cancelMandateRequest Request containing the reason for cancelling the mandate (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\CancelMandateResponse|\Academe\Starling\PaymentsSdk\Model\CancelMandateResponse
     */
    public function cancelMandate($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $cancelMandateRequest)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->cancelMandateWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $cancelMandateRequest);
    ...
    /**
     * Operation cancelMandateWithHttpInfo
     *
     * Cancels the specified mandate so that direct debit payments will no longer be accepted for it
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\CancelMandateResponse|\Academe\Starling\PaymentsSdk\Model\CancelMandateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelMandateWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $cancelMandateRequest)
    {
        $request = $this->cancelMandateRequest($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $cancelMandateRequest);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\CancelMandateResponse'),
                    'request' => $request,
                    'response' => $response
                ];
            case 400:
        ...
        $returnType = '\Academe\Starling\PaymentsSdk\Model\CancelMandateResponse';
    ...
    /**
     * Create request for operation 'cancelMandate'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     ...
     */
    public function cancelMandateRequest($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $cancelMandateRequest)
    {
        ...
        // Verify the required parameter 'mandateUid' is set

        if ($mandateUid === null || (is_array($mandateUid) && count($mandateUid) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
                'mandateUid',
                'cancelMandate'
        ...
        // Verify the required parameter 'cancelMandateRequest' is set

        if ($cancelMandateRequest === null || (is_array($cancelMandateRequest) && count($cancelMandateRequest) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address/{addressUid}/mandate/{mandateUid}/cancel';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
        ...
        if ($mandateUid !== null) {
            $resourcePath = str_replace(
                '{' . 'mandateUid' . '}',
                ObjectSerializer::toPathValue($mandateUid),
                $resourcePath
            );
        }
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($cancelMandateRequest)) {
            $_tempBody = $cancelMandateRequest;
        }
     ...
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\DirectDebitMandate
     */
    public function getMandate($paymentBusinessUid, $accountUid, $addressUid, $mandateUid)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->getMandateWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $mandateUid);
     ...
     * @throws RequestExceptionInterface if the request is malformed
     * @throws NetworkExceptionInterface if the network is down
     * @return array of \Academe\Starling\PaymentsSdk\Model\DirectDebitMandate, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMandateWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $mandateUid)
    {
        $request = $this->getMandateRequest($paymentBusinessUid, $accountUid, $addressUid, $mandateUid);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\DirectDebitMandate'),
                    'request' => $request,
                    'response' => $response
                ];
        }

        $returnType = '\Academe\Starling\PaymentsSdk\Model\DirectDebitMandate';
     ...
     * @return RequestInterface
     */
    public function getMandateRequest($paymentBusinessUid, $accountUid, $addressUid, $mandateUid)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address/{addressUid}/mandate/{mandateUid}';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
    ...
    /**
     * Operation listMandatesForAddress
     *
     ...
     * @return \Academe\Starling\PaymentsSdk\Model\DirectDebitMandate[]
     */
    public function listMandatesForAddress($paymentBusinessUid, $accountUid, $addressUid)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->listMandatesForAddressWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid);
    ...
    /**
     * Operation listMandatesForAddressWithHttpInfo
     *
     * Lists all the direct debit mandates associated with the specified address
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\DirectDebitMandate[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listMandatesForAddressWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid)
    {
        $request = $this->listMandatesForAddressRequest($paymentBusinessUid, $accountUid, $addressUid);
    ...
    /**
     * Create request for operation 'listMandatesForAddress'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     ...
     * @return RequestInterface
     */
    public function listMandatesForAddressRequest($paymentBusinessUid, $accountUid, $addressUid)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address/{addressUid}/mandate';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
    ...
    /**
     * Operation listPaymentsForMandate
     *
     ...
     * @param  string $addressUid The identifier of the individual account address (required)
     * @param  string $mandateUid The identifier of the individual mandate (required)
     * @param  int $page Page number (pages of 100 payments) to return for the specified mandate (optional, default to 1)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\DirectDebitPayment[]
     */
    public function listPaymentsForMandate($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $page = 1)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->listPaymentsForMandateWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $page);
    ...
    /**
     * Operation listPaymentsForMandateWithHttpInfo
     *
     * Lists all the direct debit payments associated with the specified mandate, returns in pages of up to 100 with the most recent payments first
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @throws RequestExceptionInterface if the request is malformed
     * @throws NetworkExceptionInterface if the network is down
     * @return array of \Academe\Starling\PaymentsSdk\Model\DirectDebitPayment[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listPaymentsForMandateWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $page = 1)
    {
        $request = $this->listPaymentsForMandateRequest($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $page);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\DirectDebitPayment[]'),
                    'request' => $request,
                    'response' => $response
                ];
        }

        $returnType = '\Academe\Starling\PaymentsSdk\Model\DirectDebitPayment[]';
    ...
    /**
     * Create request for operation 'listPaymentsForMandate'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     ...
     * @return RequestInterface
     */
    public function listPaymentsForMandateRequest($paymentBusinessUid, $accountUid, $addressUid, $mandateUid, $page = 1)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address/{addressUid}/mandate/{mandateUid}/payment';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
