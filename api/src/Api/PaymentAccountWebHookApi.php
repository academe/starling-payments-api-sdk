...
/**
 * PaymentAccountWebHookApi Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaymentAccountWebHookApi
{
    /**
     * @var Configuration
     */
     ...
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\AccountTransactionNotification $accountTransactionNotification Payload with details of the transaction applied to the account (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return void
     */
    public function accountTransaction($accountTransactionNotification)
    {
        $this->accountTransactionWithHttpInfo($accountTransactionNotification);
    }

    /**
     * Operation accountTransactionWithHttpInfo
     *
     * Notification for a credit or deduction transaction applied directly to an account, rather than through an address on a payment scheme.
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\AccountTransactionNotification $accountTransactionNotification Payload with details of the transaction applied to the account (required)
     ...
     */
    public function accountTransactionWithHttpInfo($accountTransactionNotification)
    {
        $request = $this->accountTransactionRequest($accountTransactionNotification);
    ...
    /**
     * Create request for operation 'accountTransaction'
     *
     * @param  \Academe\Starling\PaymentsSdk\Model\AccountTransactionNotification $accountTransactionNotification Payload with details of the transaction applied to the account (required)
     *
     * @throws InvalidArgumentException
     ...
     */
    public function accountTransactionRequest($accountTransactionNotification)
    {
        // Verify the required parameter 'accountTransactionNotification' is set

        if ($accountTransactionNotification === null || (is_array($accountTransactionNotification) && count($accountTransactionNotification) === 0)) {
        ...
        $resourcePath = '/your-registered-web-hook-address/account-transaction';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($accountTransactionNotification)) {
            $_tempBody = $accountTransactionNotification;
        }
