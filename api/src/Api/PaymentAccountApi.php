...
/**
 * PaymentAccountApi Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
...
class PaymentAccountApi
{
     ...
     * @param  \Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountRequest $createPaymentAccountRequest Payload describing the account to be created (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountResponse|\Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountResponse
     */
    public function createAccount($paymentBusinessUid, $accountUid, $createPaymentAccountRequest)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->createAccountWithHttpInfo($paymentBusinessUid, $accountUid, $createPaymentAccountRequest);
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountResponse|\Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAccountWithHttpInfo($paymentBusinessUid, $accountUid, $createPaymentAccountRequest)
    {
        $request = $this->createAccountRequest($paymentBusinessUid, $accountUid, $createPaymentAccountRequest);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountResponse'),
                    'request' => $request,
                    'response' => $response
                ];
            case 400:
        ...
        $returnType = '\Academe\Starling\PaymentsSdk\Model\CreatePaymentAccountResponse';
     ...
     */
    public function createAccountRequest($paymentBusinessUid, $accountUid, $createPaymentAccountRequest)
    {
        ...
        // Verify the required parameter 'createPaymentAccountRequest' is set

        if ($createPaymentAccountRequest === null || (is_array($createPaymentAccountRequest) && count($createPaymentAccountRequest) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($createPaymentAccountRequest)) {
            $_tempBody = $createPaymentAccountRequest;
        }
     ...
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\PaymentAccount
     */
    public function getPaymentAccount($paymentBusinessUid, $accountUid)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->getPaymentAccountWithHttpInfo($paymentBusinessUid, $accountUid);
     ...
     * @throws RequestExceptionInterface if the request is malformed
     * @throws NetworkExceptionInterface if the network is down
     * @return array of \Academe\Starling\PaymentsSdk\Model\PaymentAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentAccountWithHttpInfo($paymentBusinessUid, $accountUid)
    {
        $request = $this->getPaymentAccountRequest($paymentBusinessUid, $accountUid);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\PaymentAccount'),
                    'request' => $request,
                    'response' => $response
                ];
        }

        $returnType = '\Academe\Starling\PaymentsSdk\Model\PaymentAccount';
     ...
     * @return RequestInterface
     */
    public function getPaymentAccountRequest($paymentBusinessUid, $accountUid)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
...
// Path parameters
     ...
     * @return \Academe\Starling\PaymentsSdk\Model\PaymentAccount[]
     */
    public function getPaymentAccounts($paymentBusinessUid)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->getPaymentAccountsWithHttpInfo($paymentBusinessUid);
    ...
    /**
     * Operation getPaymentAccountsWithHttpInfo
     *
     * List payment accounts for a payment business
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\PaymentAccount[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentAccountsWithHttpInfo($paymentBusinessUid)
    {
        $request = $this->getPaymentAccountsRequest($paymentBusinessUid);
    ...
    /**
     * Create request for operation 'getPaymentAccounts'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     *
     * @throws InvalidArgumentException
     * @return RequestInterface
     */
    public function getPaymentAccountsRequest($paymentBusinessUid)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
