...
/**
 * PaymentServiceBusinessApi Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaymentServiceBusinessApi
{
    /**
     * @var Configuration
     */
    ...
    /**
     * Operation getBusinessInformation
     *
     ...
     * @return \Academe\Starling\PaymentsSdk\Model\BusinessInformation
     */
    public function getBusinessInformation($paymentBusinessUid)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->getBusinessInformationWithHttpInfo($paymentBusinessUid);
    ...
    /**
     * Operation getBusinessInformationWithHttpInfo
     *
     * Gets details of the payment business
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\BusinessInformation, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBusinessInformationWithHttpInfo($paymentBusinessUid)
    {
        $request = $this->getBusinessInformationRequest($paymentBusinessUid);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\BusinessInformation'),
                    'request' => $request,
                    'response' => $response
                ];
        }

        $returnType = '\Academe\Starling\PaymentsSdk\Model\BusinessInformation';
    ...
    /**
     * Create request for operation 'getBusinessInformation'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     *
     * @throws InvalidArgumentException
     ...
     */
    public function getBusinessInformationRequest($paymentBusinessUid)
    {
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
