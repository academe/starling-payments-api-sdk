...
/**
 * SendPaymentsApi Class Doc Comment
 *
 * @category Class
 * @package  Academe\Starling\PaymentsSdk
 * @author   OpenAPI Generator team
...
class SendPaymentsApi
{
    ...
    /**
     * Operation instructDomesticPayment
     *
     ...
     * @param  string $paymentUid Identifier of the payment to be sent, assigned by the sending client for idempotency reasons (required)
     * @param  \Academe\Starling\PaymentsSdk\Model\DomesticPaymentInstructionRequest $domesticPaymentInstructionRequest Payload describing the payment to be instructed (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\DomesticPaymentInstructionResponse|\Academe\Starling\PaymentsSdk\Model\DomesticPaymentInstructionResponse
     */
    public function instructDomesticPayment($paymentBusinessUid, $accountUid, $addressUid, $paymentUid, $domesticPaymentInstructionRequest)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->instructDomesticPaymentWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $paymentUid, $domesticPaymentInstructionRequest);
    ...
    /**
     * Operation instructDomesticPaymentWithHttpInfo
     *
     * Instructs a new domestic (within the UK) payment for an account, via an address assigned to the account
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @return array of \Academe\Starling\PaymentsSdk\Model\DomesticPaymentInstructionResponse|\Academe\Starling\PaymentsSdk\Model\DomesticPaymentInstructionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function instructDomesticPaymentWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $paymentUid, $domesticPaymentInstructionRequest)
    {
        $request = $this->instructDomesticPaymentRequest($paymentBusinessUid, $accountUid, $addressUid, $paymentUid, $domesticPaymentInstructionRequest);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\DomesticPaymentInstructionResponse'),
                    'request' => $request,
                    'response' => $response
                ];
            case 400:
        ...
        $returnType = '\Academe\Starling\PaymentsSdk\Model\DomesticPaymentInstructionResponse';
    ...
    /**
     * Create request for operation 'instructDomesticPayment'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     ...
     */
    public function instructDomesticPaymentRequest($paymentBusinessUid, $accountUid, $addressUid, $paymentUid, $domesticPaymentInstructionRequest)
    {
        ...
        // Verify the required parameter 'domesticPaymentInstructionRequest' is set

        if ($domesticPaymentInstructionRequest === null || (is_array($domesticPaymentInstructionRequest) && count($domesticPaymentInstructionRequest) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address/{addressUid}/payment/{paymentUid}/domestic';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($domesticPaymentInstructionRequest)) {
            $_tempBody = $domesticPaymentInstructionRequest;
        }
    ...
    /**
     * Operation instructPaymentOriginatingOverseas
     *
     ...
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $paymentUid Identifier of the payment to be sent, assigned by the sending client for idempotency reasons (required)
     * @param  \Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasInstructionRequest $paymentOriginatingOverseasInstructionRequest Payload describing the payment to be instructed (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasInstructionResponse|\Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasInstructionResponse
     */
    public function instructPaymentOriginatingOverseas($paymentBusinessUid, $accountUid, $paymentUid, $paymentOriginatingOverseasInstructionRequest)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->instructPaymentOriginatingOverseasWithHttpInfo($paymentBusinessUid, $accountUid, $paymentUid, $paymentOriginatingOverseasInstructionRequest);
    ...
    /**
     * Operation instructPaymentOriginatingOverseasWithHttpInfo
     *
     * Instructs a new domestic (within the UK) payment for an account, which originated from an account overseas, often in a foreign currency
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @throws RequestExceptionInterface if the request is malformed
     * @throws NetworkExceptionInterface if the network is down
     * @return array of \Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasInstructionResponse|\Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasInstructionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function instructPaymentOriginatingOverseasWithHttpInfo($paymentBusinessUid, $accountUid, $paymentUid, $paymentOriginatingOverseasInstructionRequest)
    {
        $request = $this->instructPaymentOriginatingOverseasRequest($paymentBusinessUid, $accountUid, $paymentUid, $paymentOriginatingOverseasInstructionRequest);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasInstructionResponse'),
                    'request' => $request,
                    'response' => $response
                ];
            case 400:
        ...
        $returnType = '\Academe\Starling\PaymentsSdk\Model\PaymentOriginatingOverseasInstructionResponse';
    ...
    /**
     * Create request for operation 'instructPaymentOriginatingOverseas'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $paymentUid Identifier of the payment to be sent, assigned by the sending client for idempotency reasons (required)
     ...
     * @return RequestInterface
     */
    public function instructPaymentOriginatingOverseasRequest($paymentBusinessUid, $accountUid, $paymentUid, $paymentOriginatingOverseasInstructionRequest)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        // Verify the required parameter 'paymentOriginatingOverseasInstructionRequest' is set

        if ($paymentOriginatingOverseasInstructionRequest === null || (is_array($paymentOriginatingOverseasInstructionRequest) && count($paymentOriginatingOverseasInstructionRequest) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/payment/{paymentUid}/domestic-originating-overseas';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($paymentOriginatingOverseasInstructionRequest)) {
            $_tempBody = $paymentOriginatingOverseasInstructionRequest;
        }
     ...
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     * @param  string $paymentUid The identifier of the new outbound payment returning the inbound payment specified in the payload (required)
     * @param  \Academe\Starling\PaymentsSdk\Model\PaymentReturnRequest $paymentReturnRequest Payload describing the payment to be returned and reason for the return (required)
     *
     * @throws \Academe\Starling\PaymentsSdk\ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \Academe\Starling\PaymentsSdk\Model\PaymentReturnResponse|\Academe\Starling\PaymentsSdk\Model\PaymentReturnResponse
     */
    public function returnPayment($paymentBusinessUid, $accountUid, $addressUid, $paymentUid, $paymentReturnRequest)
    {
        ['model' => $model, 'request' => $request, 'response' => $response]
            = $this->returnPaymentWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $paymentUid, $paymentReturnRequest);
    ...
    /**
     * Operation returnPaymentWithHttpInfo
     *
     * Returns a previously received inbound payment to the sender with a given reason. If the payment received originated overseas, the payment will be returned to the UK based instructing agent
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     ...
     * @throws RequestExceptionInterface if the request is malformed
     * @throws NetworkExceptionInterface if the network is down
     * @return array of \Academe\Starling\PaymentsSdk\Model\PaymentReturnResponse|\Academe\Starling\PaymentsSdk\Model\PaymentReturnResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function returnPaymentWithHttpInfo($paymentBusinessUid, $accountUid, $addressUid, $paymentUid, $paymentReturnRequest)
    {
        $request = $this->returnPaymentRequest($paymentBusinessUid, $accountUid, $addressUid, $paymentUid, $paymentReturnRequest);
        ...
        switch($statusCode) {
            case 200:
                return [
                    'model' => ObjectSerializer::deserialize($response, '\Academe\Starling\PaymentsSdk\Model\PaymentReturnResponse'),
                    'request' => $request,
                    'response' => $response
                ];
            case 400:
        ...
        $returnType = '\Academe\Starling\PaymentsSdk\Model\PaymentReturnResponse';
    ...
    /**
     * Create request for operation 'returnPayment'
     *
     * @param  string $paymentBusinessUid The identifier of the payment business (required)
     * @param  string $accountUid The identifier of the individual payment account (required)
     * @param  string $addressUid The identifier of the individual account address (required)
     ...
     * @return RequestInterface
     */
    public function returnPaymentRequest($paymentBusinessUid, $accountUid, $addressUid, $paymentUid, $paymentReturnRequest)
    {
        // Verify the required parameter 'paymentBusinessUid' is set
        ...
        // Verify the required parameter 'paymentReturnRequest' is set

        if ($paymentReturnRequest === null || (is_array($paymentReturnRequest) && count($paymentReturnRequest) === 0)) {
            throw new InvalidArgumentException(sprintf(
                'Missing the required parameter $%s when calling %s',
        ...
        $resourcePath = '/api/v1/{paymentBusinessUid}/account/{accountUid}/address/{addressUid}/payment/{paymentUid}/return';
        $formParams = [];
        $queryParams = [];
        $httpBody = null;
        $multipart = false;
...
// Path parameters
        ...
        // Body parameter
        $_tempBody = null;
        if (isset($paymentReturnRequest)) {
            $_tempBody = $paymentReturnRequest;
        }
